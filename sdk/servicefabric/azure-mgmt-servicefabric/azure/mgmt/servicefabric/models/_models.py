...
class ApplicationMetricDescription(_Model):
    ...
    :ivar reservation_capacity: The node reservation capacity for Service Fabric application.
     ...
     If MinimumNodes is specified, then the product of these values will be the capacity reserved in
     the cluster for the application.
...
class ApplicationResourceUpdate(ProxyResourceAutoGenerated):
...
class ArmRollingUpgradeMonitoringPolicy(_Model):
    ...
    health_check_wait_duration: Optional[datetime.timedelta] = rest_field(
    ...
    """The amount of time to wait after completing an upgrade domain before applying health policies.
     ...
     \"hh:mm:ss.fff\"."""
    health_check_stable_duration: Optional[datetime.timedelta] = rest_field(
    ...
    """The amount of time that the application or cluster must remain healthy before the upgrade
     ...
     duration with following format \"hh:mm:ss.fff\"."""
    health_check_retry_timeout: Optional[datetime.timedelta] = rest_field(
    ...
    """The amount of time to retry health evaluation when the application or cluster is unhealthy
     ...
     duration with following format \"hh:mm:ss.fff\"."""
    upgrade_timeout: Optional[datetime.timedelta] = rest_field(
    ...
    upgrade_domain_timeout: Optional[datetime.timedelta] = rest_field(
    ...
    def __init__(
        ...
        *,
        ...
        health_check_wait_duration: Optional[datetime.timedelta] = None,
        health_check_stable_duration: Optional[datetime.timedelta] = None,
        health_check_retry_timeout: Optional[datetime.timedelta] = None,
        upgrade_timeout: Optional[datetime.timedelta] = None,
        upgrade_domain_timeout: Optional[datetime.timedelta] = None,
    ) -> None: ...
...
class ServiceResourceUpdate(ProxyResourceAutoGenerated):
