...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "clusterName": _SERIALIZER.url("cluster_name", cluster_name, "str"),
        "deploymentSettingsName": _SERIALIZER.url(
            "deployment_settings_name", deployment_settings_name, "str", pattern=r"^[a-zA-Z0-9-]{3,24}$"
        ),
    }
...
class DeploymentSettingsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either DeploymentSetting or the result of
         cls(response)
