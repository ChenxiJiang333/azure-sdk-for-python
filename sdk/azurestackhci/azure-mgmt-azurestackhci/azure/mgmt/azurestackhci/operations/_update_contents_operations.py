...
def build_get_request(location: str, update_content_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str", min_length=1),
        "updateContentName": _SERIALIZER.url(
            "update_content_name", update_content_name, "str", pattern=r"^[a-zA-Z0-9-.]{3,50}$"
        ),
    }
...
class UpdateContentsOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> ItemPaged["_models.UpdateContent"]:
        ...
        :type location: str
        :return: An iterator like instance of either UpdateContent or the result of cls(response)
        ...
        cls: ClsType[_models.UpdateContentListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("UpdateContentListResult", pipeline_response)
    ...
    def get(self, location: str, update_content_name: str, **kwargs: Any) -> _models.UpdateContent:
        ...
        :return: UpdateContent or the result of cls(response)
        ...
        deserialized = self._deserialize("UpdateContent", pipeline_response.http_response)
