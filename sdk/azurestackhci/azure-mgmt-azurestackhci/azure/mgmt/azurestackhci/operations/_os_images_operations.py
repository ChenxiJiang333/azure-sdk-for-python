...
def build_get_request(location: str, os_image_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str", min_length=1),
        "osImageName": _SERIALIZER.url("os_image_name", os_image_name, "str", pattern=r"^[a-zA-Z0-9-.]{3,50}$"),
    }
...
class OsImagesOperations:
    ...
    def list_by_subscription_location_resource(self, location: str, **kwargs: Any) -> ItemPaged["_models.OsImage"]:
        ...
        :type location: str
        :return: An iterator like instance of either OsImage or the result of cls(response)
        ...
        cls: ClsType[_models.OsImageListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("OsImageListResult", pipeline_response)
    ...
    def get(self, location: str, os_image_name: str, **kwargs: Any) -> _models.OsImage:
        ...
        :return: OsImage or the result of cls(response)
        ...
        deserialized = self._deserialize("OsImage", pipeline_response.http_response)
