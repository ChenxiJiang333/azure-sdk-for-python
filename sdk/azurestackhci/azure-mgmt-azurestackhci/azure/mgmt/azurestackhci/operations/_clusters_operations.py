...
def build_change_ring_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/changeRing",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
...
class ClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def _change_ring_initial(
        ...
        resource_group_name: str,
        cluster_name: str,
        change_ring_request: Union[_models.ChangeRingRequest, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(change_ring_request, (IOBase, bytes)):
            ...
            _json = self._serialize.body(change_ring_request, "ChangeRingRequest")

        _request = build_change_ring_request(
            resource_group_name=resource_group_name,
            cluster_name=cluster_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
    ...
    def begin_change_ring(
        ...
        **kwargs: Any
        ...
        :type change_ring_request: ~azure.mgmt.azurestackhci.models.ChangeRingRequest or IO[bytes]
        :return: An instance of LROPoller that returns either Cluster or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.Cluster]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
