...
def build_get_request(location: str, platform_update_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "location": _SERIALIZER.url("location", location, "str", min_length=1),
        "platformUpdateName": _SERIALIZER.url(
            "platform_update_name", platform_update_name, "str", pattern=r"^[a-zA-Z0-9-.]{3,50}$"
        ),
    }
...
class PlatformUpdatesOperations:
    ...
    def list(self, location: str, **kwargs: Any) -> ItemPaged["_models.PlatformUpdate"]:
        ...
        :type location: str
        :return: An iterator like instance of either PlatformUpdate or the result of cls(response)
        ...
        cls: ClsType[_models.PlatformUpdateListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("PlatformUpdateListResult", pipeline_response)
    ...
    def get(self, location: str, platform_update_name: str, **kwargs: Any) -> _models.PlatformUpdate:
        ...
        :return: PlatformUpdate or the result of cls(response)
        ...
        deserialized = self._deserialize("PlatformUpdate", pipeline_response.http_response)
