...
def build_reconcile_request(
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/clusters/{clusterName}/arcSettings/{arcSettingName}/reconcile",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
...
class ArcSettingsOperations:
    ...
    def _reconcile_initial(
        ...
        cluster_name: str,
        arc_setting_name: str,
        reconcile_arc_settings_request: Union[_models.ReconcileArcSettingsRequest, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(reconcile_arc_settings_request, (IOBase, bytes)):
            ...
            _json = self._serialize.body(reconcile_arc_settings_request, "ReconcileArcSettingsRequest")
    ...
    def begin_reconcile(
        ...
        **kwargs: Any
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either ArcSetting or the result of cls(response)
    ...
    def begin_reconcile(
        ...
        **kwargs: Any
        ...
        :type reconcile_arc_settings_request:
         ~azure.mgmt.azurestackhci.models.ReconcileArcSettingsRequest or IO[bytes]
        :return: An instance of LROPoller that returns either ArcSetting or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.azurestackhci.models.ArcSetting]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
