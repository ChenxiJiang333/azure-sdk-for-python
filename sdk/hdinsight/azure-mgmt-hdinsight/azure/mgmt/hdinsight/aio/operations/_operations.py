...
class PrivateLinkResourcesOperations:
    ...
    def list_by_cluster(
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.hdinsight.models.PrivateLinkResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
...
class ConfigurationsOperations:
    ...
    async def _update_initial(
        ...
        parameters: Union[_models.ClusterConfiguration, JSON, IO[bytes]],
        **kwargs: Any
    ) -> AsyncIterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def begin_update(
        ...
        cluster_name: str,
        configuration_name: str,
        parameters: _models.ClusterConfiguration,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> AsyncLROPoller[None]:
        ...
        :param parameters: The cluster configurations. Required.
        :type parameters: ~azure.mgmt.hdinsight.models.ClusterConfiguration
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of AsyncLROPoller that returns None
    ...
    async def begin_update(
        ...
        **kwargs: Any
        ...
        :type configuration_name: str
        :param parameters: The cluster configurations. Is one of the following types:
         ClusterConfiguration, JSON, IO[bytes] Required.
        :type parameters: ~azure.mgmt.hdinsight.models.ClusterConfiguration or JSON or IO[bytes]
        :return: An instance of AsyncLROPoller that returns None
        :rtype: ~azure.core.polling.AsyncLROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    async def get(
        ...
        :param configuration_name: The name of the cluster configuration. Required.
        :type configuration_name: str
        :return: ClusterConfiguration. The ClusterConfiguration is compatible with MutableMapping
        :rtype: ~azure.mgmt.hdinsight.models.ClusterConfiguration
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models.ClusterConfiguration] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models.ClusterConfiguration, response.json())
...
class ScriptActionsOperations:
    ...
    def list_by_cluster(
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(List[_models.RuntimeScriptActionDetail], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
