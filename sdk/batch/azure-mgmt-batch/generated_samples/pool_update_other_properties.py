    ...
    response = client.pool.update(
        ...
        parameters={
            "properties": {
                ...
                "certificates": [
                    {
                        "id": "/subscriptions/12345678-1234-1234-1234-123456789012/resourceGroups/default-azurebatch-japaneast/providers/Microsoft.Batch/batchAccounts/sampleacct/pools/testpool/certificates/sha1-1234567",
...
# x-ms-original-file: 2024-07-01/PoolUpdate_OtherProperties.json
