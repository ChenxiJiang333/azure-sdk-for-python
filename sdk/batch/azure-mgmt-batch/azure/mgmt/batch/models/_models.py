...
class CertificateBaseProperties(_Model):
    """Base certificate properties.

    :ivar thumbprint_algorithm: The algorithm of the certificate thumbprint.
    ...
    thumbprint_algorithm: Optional[str] = rest_field(
    ...
    format: Optional[Union[str, "_models.CertificateFormat"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """The format of the certificate - either Pfx or Cer. If omitted, the default is Pfx. Known values
     are: \"Pfx\" and \"Cer\"."""
...
class CertificateCreateOrUpdateParameters(AzureProxyResource):
    ...
    :vartype tags: dict[str, str]
    :ivar properties: The properties associated with the certificate.
    :vartype properties: ~azure.mgmt.batch.models.CertificateCreateOrUpdateProperties
    """
    ...
    __flattened_items = ["thumbprint_algorithm", "thumbprint", "format", "data", "password"]
...
class CertificateCreateOrUpdateProperties(CertificateBaseProperties):
    ...
    :ivar format: The format of the certificate - either Pfx or Cer. If omitted, the default is
     Pfx. Known values are: "Pfx" and "Cer".
    :vartype format: str or ~azure.mgmt.batch.models.CertificateFormat
    :ivar data: The base64-encoded contents of the certificate. Required.
    :vartype data: str
    :ivar password: The password to access the certificate's private key.
    :vartype password: str
    """

    data: str = rest_field(visibility=["read", "update"])
    """The base64-encoded contents of the certificate. Required."""
...
class CertificateProperties(CertificateBaseProperties):
    ...
    :ivar delete_certificate_error: The error which occurred while deleting the certificate.
    ...
    """The provisioned state of the resource. Known values are: \"Succeeded\", \"Deleting\", and
     \"Failed\"."""
    ...
    previous_provisioning_state: Optional[Union[str, "_models.CertificateProvisioningState"]] = rest_field(
        name="previousProvisioningState", visibility=["read"]
    )
    """The previous provisioned state of the resource. Known values are: \"Succeeded\", \"Deleting\",
     and \"Failed\"."""
    previous_provisioning_state_transition_time: Optional[datetime.datetime] = rest_field(
        name="previousProvisioningStateTransitionTime", visibility=["read"], format="rfc3339"
    )
...
class CertificateReference(_Model):
    """A reference to a certificate to be installed on compute nodes in a pool. This must exist inside
    ...
    :ivar store_location: The location of the certificate store on the compute node into which to
     install the certificate. Known values are: "CurrentUser" and "LocalMachine".
    ...
    """The fully qualified ID of the certificate to install on the pool. This must be inside the same
     batch account as the pool. Required."""
    store_location: Optional[Union[str, "_models.CertificateStoreLocation"]] = rest_field(
    ...
    """The location of the certificate store on the compute node into which to install the
     certificate. Known values are: \"CurrentUser\" and \"LocalMachine\"."""
...
class DeleteCertificateError(_Model):
    """An error response from the Batch service.
    ...
    target: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """The target of the particular error. For example, the name of the property in error."""
    details: Optional[list["_models.DeleteCertificateError"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """A list of additional details about the error."""
...
class NodePlacementConfiguration(_Model):
    ...
    :ivar policy: The placement policy for allocating nodes in the pool. Known values are:
     "Regional" and "Zonal".
    ...
    """The placement policy for allocating nodes in the pool. Known values are: \"Regional\" and
     \"Zonal\"."""
...
class PoolProperties(_Model):
    ...
    :ivar certificates: The list of certificates to be installed on each compute node in the pool.
    ...
    :ivar target_node_communication_mode: Determines how a pool communicates with the Batch
    ...
    :ivar resource_tags: The user-specified tags associated with the pool.
    ...
    certificates: Optional[list["_models.CertificateReference"]] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    application_licenses: Optional[list[str]] = rest_field(
        name="applicationLicenses", visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    """Determines how a pool communicates with the Batch service. Known values are: \"Default\",
