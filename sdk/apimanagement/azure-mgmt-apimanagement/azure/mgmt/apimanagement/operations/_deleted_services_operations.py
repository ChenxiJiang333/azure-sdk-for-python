...
def build_get_by_name_request(location: str, service_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_purge_request(location: str, service_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DeletedServicesOperations:
    ...
    @distributed_trace
    def get_by_name(self, location: str, service_name: str, **kwargs: Any) -> _models.DeletedServiceContract:
    ...
    def _purge_initial(self, location: str, service_name: str, **kwargs: Any) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
            409: ResourceExistsError,
    ...
    @distributed_trace
    def begin_purge(self, location: str, service_name: str, **kwargs: Any) -> LROPoller[_models.DeletedServiceContract]:
