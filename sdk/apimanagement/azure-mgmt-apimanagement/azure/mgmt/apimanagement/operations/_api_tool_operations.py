...
def build_list_by_api_request(
    ...
    **kwargs: Any
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tools",
    )
...
def build_get_request(
    resource_group_name: str, service_name: str, api_id: str, tool_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/tools/{toolId}",
    )
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url(
        ...
        "apiId": _SERIALIZER.url("api_id", api_id, "str", max_length=256, min_length=1, pattern=r"^[^*#&+:<>?]+$"),
        "toolId": _SERIALIZER.url(
            "tool_id", tool_id, "str", max_length=80, min_length=1, pattern=r"(^[\w]+$)|(^[\w][\w\-]+[\w]$)"
        ),
    }
...
class ApiToolOperations:
    ...
    def list_by_api(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ToolContract"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.ToolContract]
