...
def build_list_by_service_request(
    ...
    **kwargs: Any
    ...
    if expand_comments_attachments is not None:
        _params["expandCommentsAttachments"] = _SERIALIZER.query(
            "expand_comments_attachments", expand_comments_attachments, "bool"
        )
    if top is not None:
...
def build_get_entity_tag_request(
    resource_group_name: str, service_name: str, api_id: str, issue_id: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ApiIssueOperations:
    ...
    def list_by_service(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.IssueContract"]:
