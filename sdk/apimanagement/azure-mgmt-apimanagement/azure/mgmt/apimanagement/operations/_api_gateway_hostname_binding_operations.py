...
def build_get_request(
    resource_group_name: str, gateway_name: str, hostname_binding_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "hostnameBindingName": _SERIALIZER.url(
...
class ApiGatewayHostnameBindingOperations:
    ...
    def list_by_gateway(
    ...
    ) -> ItemPaged["_models.GatewayHostnameBindingResource"]:
        ...
        :return: An iterator like instance of either GatewayHostnameBindingResource or the result of
         cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.GatewayHostnameBindingResource]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.GatewayHostnameBindingResource]:
        ...
        :return: An instance of LROPoller that returns either GatewayHostnameBindingResource or the
         result of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.apimanagement.models.GatewayHostnameBindingResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        if cont_token:
            return LROPoller[_models.GatewayHostnameBindingResource].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.GatewayHostnameBindingResource](
