...
class AuthorizationOperations:
    ...
    def list_by_authorization_provider(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.AuthorizationContract"]:
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_list_by_authorization_provider_request(
    ...
    def create_or_update(
        ...
        authorization_provider_id: str,
        authorization_id: str,
        parameters: Union[_models.AuthorizationContract, IO[bytes]],
        if_match: Optional[str] = None,
        **kwargs: Any
    ) -> _models.AuthorizationContract:
        """Creates or updates authorization.
        ...
        :param parameters: Create parameters. Is either a AuthorizationContract type or a IO[bytes]
         type. Required.
        :type parameters: ~azure.mgmt.apimanagement.models.AuthorizationContract or IO[bytes]
        :param if_match: ETag of the Entity. Not required when creating an entity, but required when
         updating an entity. Default value is None.
        :type if_match: str
        :return: AuthorizationContract or the result of cls(response)
    ...
    def confirm_consent_code(  # pylint: disable=inconsistent-return-statements
        ...
        authorization_provider_id: str,
        authorization_id: str,
        parameters: Union[_models.AuthorizationConfirmConsentCodeRequestContract, IO[bytes]],
        **kwargs: Any
    ) -> None:
        """Confirm valid consent code to suppress Authorizations anti-phishing page.
        ...
        :type parameters:
         ~azure.mgmt.apimanagement.models.AuthorizationConfirmConsentCodeRequestContract or IO[bytes]
        :return: None or the result of cls(response)
        :rtype: None
        :raises ~azure.core.exceptions.HttpResponseError:
        """
