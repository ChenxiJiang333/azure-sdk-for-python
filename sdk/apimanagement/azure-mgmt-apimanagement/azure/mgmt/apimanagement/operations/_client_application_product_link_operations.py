...
def build_list_by_client_applications_request(  # pylint: disable=name-too-long
...
def build_get_request(
    ...
    **kwargs: Any
    ...
    path_format_arguments = {
        ...
        "clientApplicationProductLinkId": _SERIALIZER.url(
...
class ClientApplicationProductLinkOperations:
    ...
    def list_by_client_applications(
        ...
        skip: Optional[int] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.ClientApplicationProductLinkContract"]:
        ...
        :return: An iterator like instance of either ClientApplicationProductLinkContract or the result
         of cls(response)
        :rtype:
         ~azure.core.paging.ItemPaged[~azure.mgmt.apimanagement.models.ClientApplicationProductLinkContract]
