...
from .._configuration import CertificateRegistrationClientConfiguration
...
class AppServiceCertificateOrdersOperations:  # pylint: disable=too-many-public-methods
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.certificateregistration.aio.CertificateRegistrationClient`'s
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._config: CertificateRegistrationClientConfiguration = (
    ...
    async def get(
        ...
        if response.status_code not in [200]:
            ...
            error = _failsafe_deserialize(_models.DefaultErrorResponse, response)
