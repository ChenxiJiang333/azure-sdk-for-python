...
# USAGE
    python replication_protected_items_planned_failover.py
...
# x-ms-original-file: specification/recoveryservicessiterecovery/resource-manager/Microsoft.RecoveryServices/SiteRecovery/stable/2025-08-01/examples/ReplicationProtectedItems_PlannedFailover.json
