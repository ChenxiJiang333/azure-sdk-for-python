...
class TestHealthcareApisManagementIotConnectorsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_iot_connectors_begin_update(self, resource_group):
        response = self.client.iot_connectors.begin_update(
            resource_group_name=resource_group.name,
            workspace_name="str",
            iot_connector_name="str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_iot_connectors_begin_delete(self, resource_group):
        response = self.client.iot_connectors.begin_delete(
            resource_group_name=resource_group.name,
            workspace_name="str",
            iot_connector_name="str",
        ).result()  # call '.result()' to poll until service return final result
