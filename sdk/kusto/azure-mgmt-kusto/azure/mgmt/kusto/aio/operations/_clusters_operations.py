...
from ...operations._clusters_operations import (
    build_add_callout_policies_request,
    ...
    build_list_callout_policies_request,
    build_list_follower_databases_get_request,
    ...
    build_remove_callout_policy_request,
...
class ClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    async def check_name_availability(
        ...
        :param location: The name of Azure region. Required.
        :type location: str
        :param cluster_name: The request body. Is either a ClusterCheckNameRequest type or a IO[bytes]
         type. Required.
    ...
    def list_language_extensions(
        self, resource_group_name: str, cluster_name: str, **kwargs: Any
    ) -> AsyncItemPaged["_models.LanguageExtension"]:
