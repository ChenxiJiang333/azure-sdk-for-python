...
class DeploymentsMgmtClient:
    ...
    :vartype deployments: azure.mgmt.resource.deployments.aio.operations.DeploymentsOperations
    :ivar deployment_operations: DeploymentOperationsOperations operations
    :vartype deployment_operations:
     azure.mgmt.resource.deployments.aio.operations.DeploymentOperationsOperations
