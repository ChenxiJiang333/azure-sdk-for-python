...
class ResourceSnapshotData(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword timestamp: The time when the snapshot was created. The snapshot timestamp provides an
         approximation as to when a modification to a resource was detected.  There can be a difference
         between the actual modification time and the detection time.  This is due to differences in how
         operations that modify a resource are processed, versus how operation that record resource
         snapshots are processed. Required.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.resourcegraph.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.resourcegraph.models.CreatedByType
