...
class ParameterDefinitions(_Model):
...
class PolicyAssignmentProperties(_Model):
    ...
    :ivar parameters: The parameter values for the assigned policy rule. The keys are the parameter
     names.
    :vartype parameters: ~azure.mgmt.resource.policy.models.ParameterValues
    ...
    parameters: Optional["_models.ParameterValues"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        parameters: Optional["_models.ParameterValues"] = None,
        description: Optional[str] = None,
...
class PolicyDefinitionProperties(_Model):
    ...
    :vartype parameters: ~azure.mgmt.resource.policy.models.ParameterDefinitions
    ...
    """The policy definition metadata.  Metadata is an open ended object and is typically a collection
     of key value pairs."""
    parameters: Optional["_models.ParameterDefinitions"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        ...
        metadata: Optional[Any] = None,
        parameters: Optional["_models.ParameterDefinitions"] = None,
