...
def build_list_request(subscription_id: str, provider_id: str, location: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class QuotaOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :return: An instance of LROPoller that returns either CurrentQuotaLimitBase or An instance of
         LROPoller that returns either QuotaRequestSubmitResponse201 or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.reservations.models.CurrentQuotaLimitBase] or
         ~azure.core.polling.LROPoller[~azure.mgmt.reservations.models.QuotaRequestSubmitResponse201]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
