...
class CalculateRefundOperations:
    ...
    @distributed_trace
    def post(
        self, reservation_order_id: str, body: Union[_models.CalculateRefundRequest, IO[bytes]], **kwargs: Any
    ) -> _models.CalculateRefundResponse:
        """Calculate the refund amount of a reservation order.
        ...
        :type body: ~azure.mgmt.reservations.models.CalculateRefundRequest or IO[bytes]
        :return: CalculateRefundResponse or the result of cls(response)
        :rtype: ~azure.mgmt.reservations.models.CalculateRefundResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        deserialized = self._deserialize("CalculateRefundResponse", pipeline_response.http_response)
