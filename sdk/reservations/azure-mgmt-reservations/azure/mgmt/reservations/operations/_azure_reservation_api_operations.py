...
def build_get_applied_reservation_list_request(  # pylint: disable=name-too-long
...
class _AzureReservationAPIOperationsMixin(
    ClientMixinABC[PipelineClient[HttpRequest, HttpResponse], AzureReservationAPIConfiguration]
):
    ...
    def get_applied_reservation_list(self, subscription_id: str, **kwargs: Any) -> _models.AppliedReservations:
        ...
        deserialized = self._deserialize("AppliedReservations", pipeline_response.http_response)
