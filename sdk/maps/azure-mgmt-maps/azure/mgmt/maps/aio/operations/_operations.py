...
class AccountsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.mgmt.maps.aio.MapsClient`'s
    ...
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncItemPaged["_models.MapsAccount"]:
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(list[_models.MapsAccount], deserialized.get("value", []))
            if cls:
...
class CreatorsOperations:
    ...
    def list_by_account(
        ...
        async def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models.Creator], deserialized.get("value", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return deserialized.get("nextLink") or None, AsyncList(list_of_elem)
