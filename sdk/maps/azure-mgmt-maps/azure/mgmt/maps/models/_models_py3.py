...
class AccountSasParameters(_serialization.Model):
    ...
    _validation = {
        ...
        "max_rate_per_second": {"required": True, "maximum": 500, "minimum": 0},
        "start": {"required": True},
...
class CreatorList(_serialization.Model):
    ...
    :ivar value: The Creator items on this page. Required.
    ...
    def __init__(self, *, value: list["_models.Creator"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The Creator items on this page. Required.
        :paramtype value: list[~azure.mgmt.maps.models.Creator]
...
class MapsAccounts(_serialization.Model):
    ...
    :ivar value: The MapsAccount items on this page. Required.
    ...
    def __init__(self, *, value: list["_models.MapsAccount"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The MapsAccount items on this page. Required.
        :paramtype value: list[~azure.mgmt.maps.models.MapsAccount]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
