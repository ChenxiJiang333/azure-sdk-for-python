...
from ...operations._ingestion_private_endpoint_connections_operations import (
    build_list_request,
    build_update_status_request,
)
    ...
    async def update_status(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize(
            "PrivateEndpointConnectionStatusUpdateResponse", pipeline_response.http_response
        )
