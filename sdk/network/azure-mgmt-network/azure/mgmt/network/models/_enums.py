...
class VmssAccessMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The access mode of the private link service."""
...
class VmssDdosSettingsProtectionMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The DDoS protection mode of the public IP."""
...
class VmssDeleteOptions(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Specify what happens to the public IP address when the VM using it is deleted."""
...
class VmssExtendedLocationTypes(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The supported ExtendedLocation types. Currently only EdgeZone is supported in Microsoft.Network
    resources.
    """
...
class VmssFlowLogFormatType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The file type of flow log."""
...
class VmssGatewayLoadBalancerTunnelInterfaceType(  # pylint: disable=name-too-long
    str, Enum, metaclass=CaseInsensitiveEnumMeta
):
    """Traffic type of gateway load balancer tunnel interface."""
...
class VmssGatewayLoadBalancerTunnelProtocol(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Protocol of gateway load balancer tunnel interface."""
...
class VmssIPAllocationMethod(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """IP address allocation method."""
...
class VmssIPVersion(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """IP address version."""
...
class VmssLoadBalancerBackendAddressAdminState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """A list of administrative states which once set can override health probe so that Load Balancer
    will always forward new connections to backend, or deny new connections and reset existing
    connections.
    """
...
class VmssNatGatewaySkuName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Name of Nat Gateway SKU."""
...
class VmssNetworkInterfaceAuxiliaryMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Auxiliary mode of Network Interface resource."""
...
class VmssNetworkInterfaceAuxiliarySku(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Auxiliary sku of Network Interface resource."""
...
class VmssNetworkInterfaceMigrationPhase(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Migration phase of Network Interface resource."""
...
class VmssNetworkInterfaceNicType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Type of Network Interface resource."""
...
class VmssPrivateEndpointIPVersionType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Specifies the IP version type for the private IPs of the private endpoint. If not defined, this
    defaults to IPv4.
    """
...
class VmssProvisioningState(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The current provisioning state."""
...
class VmssPublicIpAddressDnsSettingsDomainNameLabelScope(  # pylint: disable=name-too-long
    str, Enum, metaclass=CaseInsensitiveEnumMeta
):
    """The domain name label scope. If a domain name label and a domain name label scope are
    specified, an A DNS record is created for the public IP in the Microsoft Azure DNS system with
...
class VmssPublicIPAddressMigrationPhase(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Migration phase of Public IP Address."""
...
class VmssPublicIPAddressSkuName(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Name of a public IP address SKU."""
...
class VmssPublicIPAddressSkuTier(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Tier of a public IP address SKU."""
...
class VmssResourceIdentityType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The type of identity used for the resource. The type 'SystemAssigned, UserAssigned' includes
    both an implicitly created identity and a set of user assigned identities. The type 'None' will
    remove any identities from the virtual machine.
    """
...
class VmssRouteNextHopType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The type of Azure hop the packet should be sent to."""
...
class VmssSecurityRuleAccess(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Whether network traffic is allowed or denied."""
...
class VmssSecurityRuleDirection(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The direction of the rule. The direction specifies if rule will be evaluated on incoming or
    outgoing traffic.
    """
...
class VmssSecurityRuleProtocol(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Network protocol this rule applies to."""
...
class VmssSharingScope(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Set this property to Tenant to allow sharing subnet with other subscriptions in your AAD
    tenant. This property can only be set if defaultOutboundAccess is set to false, both properties
    can only be set if subnet is empty.
    """
...
class VmssSyncMode(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """Backend address synchronous mode for the backend pool."""
...
class VmssTransportProtocol(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The transport protocol for the endpoint."""
...
class VmssVirtualNetworkPrivateEndpointNetworkPolicies(  # pylint: disable=name-too-long
    str, Enum, metaclass=CaseInsensitiveEnumMeta
):
    """Enable or Disable apply network policies on private end point in the subnet."""
...
class VmssVirtualNetworkPrivateLinkServiceNetworkPolicies(  # pylint: disable=name-too-long
    str, Enum, metaclass=CaseInsensitiveEnumMeta
):
    """Enable or Disable apply network policies on private link service in the subnet."""
