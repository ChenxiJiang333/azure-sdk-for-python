...
class FirewallPolicyIDPSSignatureDirection(float, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class FirewallPolicyIDPSSignatureMode(float, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class FirewallPolicyIDPSSignatureSeverity(float, Enum, metaclass=CaseInsensitiveEnumMeta):
