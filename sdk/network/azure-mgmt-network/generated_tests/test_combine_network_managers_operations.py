...
class TestCombineNetworkManagersOperations(AzureMgmtRecordedTestCase):
            ...
            parameters={
                ...
                "properties": {
                    "networkManagerScopes": {
                        "crossTenantScopes": [
                            {"managementGroups": ["str"], "subscriptions": ["str"], "tenantId": "str"}
                        ],
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_managers_list_active_connectivity_configurations(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_network_managers_list_active_security_admin_rules(self, resource_group):
