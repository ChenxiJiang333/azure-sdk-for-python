...
class TestCombineVirtualWansOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_wans_supported_security_providers(self, resource_group):
        response = self.client.virtual_wans.supported_security_providers(
            resource_group_name=resource_group.name,
            virtual_wan_name="str",
            api_version="2025-05-01",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_virtual_wans_begin_generatevirtualwanvpnserverconfigurationvpnprofile(self, resource_group):
        response = self.client.virtual_wans.begin_generatevirtualwanvpnserverconfigurationvpnprofile(
            resource_group_name=resource_group.name,
            virtual_wan_name="str",
