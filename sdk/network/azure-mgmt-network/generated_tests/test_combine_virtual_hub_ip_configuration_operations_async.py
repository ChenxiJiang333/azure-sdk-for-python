...
class TestCombineVirtualHubIpConfigurationOperationsAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(CombineClient, is_async=True)

    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_hub_ip_configuration_get(self, resource_group):
        response = await self.client.virtual_hub_ip_configuration.get(
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_hub_ip_configuration_begin_create_or_update(self, resource_group):
        response = await (
            await self.client.virtual_hub_ip_configuration.begin_create_or_update(
                resource_group_name=resource_group.name,
                virtual_hub_name="str",
                ip_config_name="str",
                parameters={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_hub_ip_configuration_begin_delete(self, resource_group):
        response = await (
            await self.client.virtual_hub_ip_configuration.begin_delete(
                resource_group_name=resource_group.name,
                virtual_hub_name="str",
                ip_config_name="str",
                api_version="2025-05-01",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_virtual_hub_ip_configuration_list(self, resource_group):
