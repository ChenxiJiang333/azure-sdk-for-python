...
class TestCombineNetworkVirtualAppliancesOperationsAsync(AzureMgmtRecordedTestCase):
                    ...
                    "properties": {
                        ...
                        "networkProfile": {
                            "networkInterfaceConfigurations": [
                                {
                                    "properties": {
                                        "ipConfigurations": [{"name": "str", "properties": {"primary": bool}}]
                                    },
                                    "type": "str",
                                }
                            ]
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_network_virtual_appliances_begin_reimage(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_network_virtual_appliances_begin_get_boot_diagnostic_logs(self, resource_group):
        response = await (
            await self.client.network_virtual_appliances.begin_get_boot_diagnostic_logs(
                resource_group_name=resource_group.name,
                network_virtual_appliance_name="str",
