...
- Deleted or renamed model `ApplicationGatewayBackendAddressPoolAutoGenerated`
- Deleted or renamed model `ApplicationGatewayIPConfigurationAutoGenerated`
- Deleted or renamed model `ApplicationGatewayWafDynamicManifestResultList`
- Deleted or renamed model `ApplicationSecurityGroupAutoGenerated`
...
- Deleted or renamed model `BackendAddressPoolAutoGenerated`
...
- Deleted or renamed model `DelegationAutoGenerated`
- Deleted or renamed model `EffectiveRouteMapRouteList`
- Deleted or renamed model `ExpressRouteConnectionList`
- Deleted or renamed model `ExpressRouteCrossConnectionPeeringList`
- Deleted or renamed model `ExpressRouteGatewayList`
- Deleted or renamed model `FlowLogAutoGenerated`
- Deleted or renamed model `FlowLogFormatParametersAutoGenerated`
- Deleted or renamed model `FrontendIPConfigurationAutoGenerated`
- Deleted or renamed model `GetServiceGatewayAddressLocationsResult`
- Deleted or renamed model `GetServiceGatewayServicesResult`
- Deleted or renamed model `IPConfigurationAutoGenerated`
- Deleted or renamed model `IPConfigurationProfileAutoGenerated`
- Deleted or renamed model `InboundNatRuleAutoGenerated`
...
- Deleted or renamed model `NatGatewayAutoGenerated`
- Deleted or renamed model `NetworkInterfaceAutoGenerated`
- Deleted or renamed model `NetworkInterfaceIPConfigurationAutoGenerated`
- Deleted or renamed model `NetworkInterfaceIPConfigurationListResultAutoGenerated`
- Deleted or renamed model `NetworkInterfaceListResultAutoGenerated`
- Deleted or renamed model `NetworkInterfaceTapConfigurationAutoGenerated`
- Deleted or renamed model `NetworkSecurityGroupAutoGenerated`
...
- Deleted or renamed model `PrivateEndpointAutoGenerated`
- Deleted or renamed model `PrivateEndpointConnectionAutoGenerated`
- Deleted or renamed model `PrivateLinkServiceAutoGenerated`
- Deleted or renamed model `PrivateLinkServiceConnectionAutoGenerated`
- Deleted or renamed model `PrivateLinkServiceIpConfigurationAutoGenerated`
- Deleted or renamed model `PublicIPAddressAutoGenerated`
- Deleted or renamed model `PublicIPAddressListResultAutoGenerated`
- Deleted or renamed model `ResourceAutoGenerated2`
- Deleted or renamed model `ResourceNavigationLinkAutoGenerated`
- Deleted or renamed model `RouteAutoGenerated`
- Deleted or renamed model `RouteTableAutoGenerated`
- Deleted or renamed model `SecurityRuleAutoGenerated`
- Deleted or renamed model `ServiceAssociationLinkAutoGenerated`
- Deleted or renamed model `ServiceEndpointPolicyAutoGenerated`
- Deleted or renamed model `ServiceEndpointPolicyDefinitionAutoGenerated`
- Deleted or renamed model `ServiceEndpointPropertiesFormatAutoGenerated`
- Deleted or renamed model `SignaturesOverridesList`
- Deleted or renamed model `StaticCidrList`
- Deleted or renamed model `SubnetAutoGenerated`
- Deleted or renamed model `VirtualHubEffectiveRouteList`
...
- Deleted or renamed model `VirtualNetworkTapAutoGenerated`
