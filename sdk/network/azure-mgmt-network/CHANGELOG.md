...
- Method `AvailableResourceGroupDelegationsOperations.list` re-ordered its parameters from `['self', 'location', 'resource_group_name', 'kwargs']` to `['self', 'resource_group_name', 'location', 'kwargs']`
- Method `PrivateLinkServicesOperations.list_auto_approved_private_link_services_by_resource_group` re-ordered its parameters from `['self', 'location', 'resource_group_name', 'kwargs']` to `['self', 'resource_group_name', 'location', 'kwargs']`
- Method `PrivateLinkServicesOperations.begin_check_private_link_service_visibility_by_resource_group` re-ordered its parameters from `['self', 'location', 'resource_group_name', 'parameters', 'kwargs']` to `['self', 'resource_group_name', 'location', 'parameters', 'kwargs']`
- Method `AvailablePrivateEndpointTypesOperations.list_by_resource_group` re-ordered its parameters from `['self', 'location', 'resource_group_name', 'kwargs']` to `['self', 'resource_group_name', 'location', 'kwargs']`
- Method `PrivateDnsZoneGroupsOperations.list` re-ordered its parameters from `['self', 'private_endpoint_name', 'resource_group_name', 'kwargs']` to `['self', 'resource_group_name', 'private_endpoint_name', 'kwargs']`
...
- Deleted or renamed model `SecurityPerimeterProxyResource`
- Deleted or renamed model `SecurityPerimeterResource`
...
- Deleted or renamed client `NetworkManagementClient`
