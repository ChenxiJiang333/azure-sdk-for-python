...
def main():
    ...
    response = client.static_sites.create_or_update_build_database_connection(
...
# x-ms-original-file: 2025-03-01/CreateOrUpdateStaticSiteBuildDatabaseConnection.json
