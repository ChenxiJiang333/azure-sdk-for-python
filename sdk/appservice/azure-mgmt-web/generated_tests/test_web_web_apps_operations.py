...
class TestWebWebAppsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_web_apps_begin_swap_slot_slot(self, resource_group):
        response = self.client.web_apps.begin_swap_slot_slot(
            resource_group_name=resource_group.name,
            name="str",
            slot="str",
            slot_swap_entity={"preserveVnet": bool, "targetSlot": "str"},
