...
class TestWebWebAppsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_web_apps_begin_swap_slot_slot(self, resource_group):
        response = await (
            await self.client.web_apps.begin_swap_slot_slot(
                resource_group_name=resource_group.name,
                name="str",
                slot="str",
                slot_swap_entity={"preserveVnet": bool, "targetSlot": "str"},
        ...
        response = await (
            await self.client.web_apps.begin_migrate_my_sql(
                ...
                migration_request_envelope={
                    ...
                    "kind": "str",
                    "name": "str",
                    "properties": {"connectionString": "str", "migrationType": "str"},
                    "type": "str",
                },
            )
        ).result()  # call '.result()' to poll until service return final result
    ...
    async def test_web_apps_create_or_update_swift_virtual_network_connection_with_check(self, resource_group):
        response = await self.client.web_apps.create_or_update_swift_virtual_network_connection_with_check(
            ...
            connection_envelope={
                ...
                "kind": "str",
                "name": "str",
                "properties": {"subnetResourceId": "str", "swiftSupported": bool},
                "systemData": {
                    "createdAt": "2020-02-20 00:00:00",
                    "createdBy": "str",
                    "createdByType": "str",
