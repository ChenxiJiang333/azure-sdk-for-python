...
class KubeEnvironmentsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.KubeEnvironment"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.web.models.KubeEnvironment]
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type kube_environment_envelope: ~azure.mgmt.web.models.KubeEnvironment or IO[bytes]
        :return: An instance of LROPoller that returns either KubeEnvironment or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.web.models.KubeEnvironment]
        :raises ~azure.core.exceptions.HttpResponseError:
