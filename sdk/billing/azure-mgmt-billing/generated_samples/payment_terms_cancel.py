...
def main():
    ...
    response = client.billing_accounts.begin_cancel_payment_terms(
        ...
        parameters="2023-01-05T22:39:34.2606750Z",
    ).result()
    print(response)


# x-ms-original-file: specification/billing/resource-manager/Microsoft.Billing/Billing/stable/2024-04-01/examples/paymentTermsCancel.json
