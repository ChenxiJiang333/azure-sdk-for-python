...
def build_get_by_billing_subscription_request(  # pylint: disable=name-too-long
    subscription_id: str, invoice_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_download_by_billing_subscription_request(  # pylint: disable=name-too-long
    subscription_id: str, invoice_name: str, *, document_name: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class InvoicesOperations:
    ...
    def _download_documents_by_billing_subscription_initial(  # pylint: disable=name-too-long
        self, subscription_id: str, parameters: Union[List[_models.DocumentDownloadRequest], IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
    ...
    @distributed_trace
    def get_by_billing_subscription(self, subscription_id: str, invoice_name: str, **kwargs: Any) -> _models.Invoice:
    ...
    def _download_by_billing_subscription_initial(  # pylint: disable=name-too-long
        self, subscription_id: str, invoice_name: str, document_name: Optional[str] = None, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
