...
def build_list_by_billing_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingRequests"
    )
    path_format_arguments = {
        "billingAccountName": _SERIALIZER.url(
            "billing_account_name",
...
def build_list_by_user_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingRequests")
...
def build_get_request(billing_request_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.Billing/billingRequests/{billingRequestName}")
    path_format_arguments = {
        "billingRequestName": _SERIALIZER.url(
...
def build_create_or_update_request(billing_request_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BillingRequestsOperations:
    ...
    def list_by_billing_profile(
        ...
        search: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.BillingRequest"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.billing.models.BillingRequest]
    ...
    @distributed_trace
    def get(self, billing_request_name: str, **kwargs: Any) -> _models.BillingRequest:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.BillingRequest]:
        ...
        :return: An instance of LROPoller that returns either BillingRequest or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.billing.models.BillingRequest]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        if cont_token:
            return LROPoller[_models.BillingRequest].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BillingRequest](
