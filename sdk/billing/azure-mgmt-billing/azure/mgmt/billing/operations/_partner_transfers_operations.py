...
def build_get_request(
    billing_account_name: str, billing_profile_name: str, customer_name: str, transfer_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class PartnerTransfersOperations:
    ...
    def list(
    ...
    ) -> ItemPaged["_models.PartnerTransferDetails"]:
        ...
        :return: An iterator like instance of either PartnerTransferDetails or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.billing.models.PartnerTransferDetails]
