...
def build_list_by_billing_account_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop(
        "template_url", "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptionAliases"
    )
...
def build_get_request(billing_account_name: str, alias_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_create_or_update_request(billing_account_name: str, alias_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class BillingSubscriptionsAliasesOperations:
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :attr:`billing_subscriptions_aliases` attribute.
    """
    ...
    def list_by_billing_account(
        ...
        search: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models.BillingSubscriptionAlias"]:
        ...
        :param search: The search query option allows clients to request items within a collection
         ...
         value is None.
        :type search: str
        :return: An iterator like instance of either BillingSubscriptionAlias or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.billing.models.BillingSubscriptionAlias]
        ...
        cls: ClsType[_models.BillingSubscriptionAliasListResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("BillingSubscriptionAliasListResult", pipeline_response)
    ...
    @distributed_trace
    def get(self, billing_account_name: str, alias_name: str, **kwargs: Any) -> _models.BillingSubscriptionAlias:
        ...
        :param billing_account_name: The ID that uniquely identifies a billing account. Required.
        :type billing_account_name: str
        :param alias_name: The ID that uniquely identifies a subscription alias. Required.
        :type alias_name: str
        :return: BillingSubscriptionAlias or the result of cls(response)
        :rtype: ~azure.mgmt.billing.models.BillingSubscriptionAlias
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.BillingSubscriptionAlias] = kwargs.pop("cls", None)
        ...
        deserialized = self._deserialize("BillingSubscriptionAlias", pipeline_response.http_response)
    ...
    def _create_or_update_initial(
        ...
        billing_account_name: str,
        alias_name: str,
        parameters: Union[_models.BillingSubscriptionAlias, IO[bytes]],
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "BillingSubscriptionAlias")
    ...
    def begin_create_or_update(
        ...
        billing_account_name: str,
        alias_name: str,
        parameters: _models.BillingSubscriptionAlias,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.BillingSubscriptionAlias]:
        ...
        :param alias_name: The ID that uniquely identifies a subscription alias. Required.
        :type alias_name: str
        :param parameters: A billing subscription alias. Required.
        :type parameters: ~azure.mgmt.billing.models.BillingSubscriptionAlias
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: An instance of LROPoller that returns either BillingSubscriptionAlias or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.billing.models.BillingSubscriptionAlias]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param alias_name: The ID that uniquely identifies a subscription alias. Required.
        :type alias_name: str
        :param parameters: A billing subscription alias. Is either a BillingSubscriptionAlias type or a
         IO[bytes] type. Required.
        :type parameters: ~azure.mgmt.billing.models.BillingSubscriptionAlias or IO[bytes]
        :return: An instance of LROPoller that returns either BillingSubscriptionAlias or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.billing.models.BillingSubscriptionAlias]
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        if cont_token:
            return LROPoller[_models.BillingSubscriptionAlias].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.BillingSubscriptionAlias](
