...
from ...operations._transfers_operations import (
...
class TransfersOperations:
    ...
    def list(
    ...
    ) -> AsyncItemPaged["_models.TransferDetails"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.billing.models.TransferDetails]
