...
class TestCognitiveServicesManagementRaiTopicsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_rai_topics_create_or_update(self, resource_group):
        response = await self.client.rai_topics.create_or_update(
            resource_group_name=resource_group.name,
            account_name="str",
            rai_topic_name="str",
            rai_topic={
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_rai_topics_begin_delete(self, resource_group):
        response = await (
            await self.client.rai_topics.begin_delete(
                resource_group_name=resource_group.name,
                account_name="str",
                rai_topic_name="str",
                api_version="2025-10-01-preview",
