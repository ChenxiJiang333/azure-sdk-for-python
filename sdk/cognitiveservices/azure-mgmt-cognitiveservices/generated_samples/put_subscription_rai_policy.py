...
# USAGE
    python put_subscription_rai_policy.py
...
def main():
    ...
    response = client.subscription_rai_policy.create_or_update(
...
# x-ms-original-file: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/PutSubscriptionRaiPolicy.json
