...
class ManagedNetworkSettings(_Model):
    ...
    egress_ip_address: Optional[str] = rest_field(name="egressIpAddress", visibility=["read"])
...
class OrganizationSharedBuiltInAuthorizationPolicy(
    ...
    :ivar type: Authorization scheme type. Required. Claim-based, requires membership in the tenant
