...
def build_get_request(
    resource_group_name: str, account_name: str, rai_tool_connection_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "raiToolConnectionName": _SERIALIZER.url(
            "rai_tool_connection_name", rai_tool_connection_name, "str", pattern=r"^[a-zA-Z0-9][a-zA-Z0-9_.-]*$"
        ),
    }
...
class RaiToolLabelsOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, account_name: str, **kwargs: Any) -> ItemPaged["_models.RaiToolLabel"]:
        ...
        :return: An iterator like instance of either RaiToolLabel or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.cognitiveservices.models.RaiToolLabel]
        ...
        cls: ClsType[_models.RaiToolLabelResult] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("RaiToolLabelResult", pipeline_response)
    ...
    def get(
        ...
        :return: RaiToolLabel or the result of cls(response)
        ...
        deserialized = self._deserialize("RaiToolLabel", pipeline_response.http_response)
    ...
    def create_or_update(
        ...
        account_name: str,
        rai_tool_connection_name: str,
        rai_tool_label: Union[_models.RaiToolLabel, IO[bytes]],
        **kwargs: Any
    ) -> _models.RaiToolLabel:
        """Creates the RAI Tool Label associated with the Azure OpenAI account.
        ...
        :type rai_tool_label: ~azure.mgmt.cognitiveservices.models.RaiToolLabel or IO[bytes]
        :return: RaiToolLabel or the result of cls(response)
        :rtype: ~azure.mgmt.cognitiveservices.models.RaiToolLabel
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(rai_tool_label, (IOBase, bytes)):
            ...
            _json = self._serialize.body(rai_tool_label, "RaiToolLabel")
