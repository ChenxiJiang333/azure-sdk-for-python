...
- Deleted or renamed client method `Client.deserialize`
- Deleted or renamed client method `Client.enable_additional_properties_sending`
- Deleted or renamed client method `Client.from_dict`
- Deleted or renamed client method `Client.is_xml_model`
- Deleted or renamed client method `Client.serialize`

- Deleted model `NetworkSecurityPerimeterConfigurationList`/`TrackedResourceAutoGenerated` which actually were not used by SDK users
...
- Model `AzureADPartnerClientAuthentication` deleted or renamed its instance variable `azure_active_directory_tenant_id`
- Model `AzureADPartnerClientAuthentication` deleted or renamed its instance variable `azure_active_directory_application_id_or_uri`
- Model `AzureFunctionEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
- Model `AzureFunctionEventSubscriptionDestination` deleted or renamed its instance variable `max_events_per_batch`
- Model `AzureFunctionEventSubscriptionDestination` deleted or renamed its instance variable `preferred_batch_size_in_kilobytes`
- Model `AzureFunctionEventSubscriptionDestination` deleted or renamed its instance variable `delivery_attribute_mappings`
- Model `CaCertificate` deleted or renamed its instance variable `description`
- Model `CaCertificate` deleted or renamed its instance variable `encoded_certificate`
- Model `CaCertificate` deleted or renamed its instance variable `issue_time_in_utc`
- Model `CaCertificate` deleted or renamed its instance variable `expiry_time_in_utc`
- Model `CaCertificate` deleted or renamed its instance variable `provisioning_state`
- Model `Channel` deleted or renamed its instance variable `channel_type`
- Model `Channel` deleted or renamed its instance variable `partner_topic_info`
- Model `Channel` deleted or renamed its instance variable `partner_destination_info`
- Model `Channel` deleted or renamed its instance variable `message_for_activation`
- Model `Channel` deleted or renamed its instance variable `provisioning_state`
- Model `Channel` deleted or renamed its instance variable `readiness_state`
- Model `Channel` deleted or renamed its instance variable `expiration_time_if_not_activated_utc`
...
- Client `Client` deleted or renamed instance variable `description`
- Client `Client` deleted or renamed instance variable `authentication_name`
- Client `Client` deleted or renamed instance variable `client_certificate_authentication`
- Client `Client` deleted or renamed instance variable `state`
- Client `Client` deleted or renamed instance variable `attributes`
- Client `Client` deleted or renamed instance variable `provisioning_state`
- Model `ClientGroup` deleted or renamed its instance variable `description`
- Model `ClientGroup` deleted or renamed its instance variable `query`
- Model `ClientGroup` deleted or renamed its instance variable `provisioning_state`
- Model `Domain` deleted or renamed its instance variable `private_endpoint_connections`
- Model `Domain` deleted or renamed its instance variable `provisioning_state`
- Model `Domain` deleted or renamed its instance variable `minimum_tls_version_allowed`
- Model `Domain` deleted or renamed its instance variable `endpoint`
- Model `Domain` deleted or renamed its instance variable `input_schema`
- Model `Domain` deleted or renamed its instance variable `event_type_info`
- Model `Domain` deleted or renamed its instance variable `input_schema_mapping`
- Model `Domain` deleted or renamed its instance variable `metric_resource_id`
- Model `Domain` deleted or renamed its instance variable `public_network_access`
- Model `Domain` deleted or renamed its instance variable `inbound_ip_rules`
- Model `Domain` deleted or renamed its instance variable `disable_local_auth`
- Model `Domain` deleted or renamed its instance variable `auto_create_topic_with_first_subscription`
- Model `Domain` deleted or renamed its instance variable `auto_delete_topic_with_last_subscription`
- Model `Domain` deleted or renamed its instance variable `data_residency_boundary`
- Model `DomainTopic` deleted or renamed its instance variable `provisioning_state`
...
- Model `DynamicDeliveryAttributeMapping` deleted or renamed its instance variable `source_field`
- Model `EventHubEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
- Model `EventHubEventSubscriptionDestination` deleted or renamed its instance variable `delivery_attribute_mappings`
- Model `EventSubscription` deleted or renamed its instance variable `topic`
- Model `EventSubscription` deleted or renamed its instance variable `provisioning_state`
- Model `EventSubscription` deleted or renamed its instance variable `destination`
- Model `EventSubscription` deleted or renamed its instance variable `delivery_with_resource_identity`
- Model `EventSubscription` deleted or renamed its instance variable `filter`
- Model `EventSubscription` deleted or renamed its instance variable `labels`
- Model `EventSubscription` deleted or renamed its instance variable `expiration_time_utc`
- Model `EventSubscription` deleted or renamed its instance variable `event_delivery_schema`
- Model `EventSubscription` deleted or renamed its instance variable `retry_policy`
- Model `EventSubscription` deleted or renamed its instance variable `dead_letter_destination`
- Model `EventSubscription` deleted or renamed its instance variable `dead_letter_with_resource_identity`
- Model `EventType` deleted or renamed its instance variable `display_name`
- Model `EventType` deleted or renamed its instance variable `description`
- Model `EventType` deleted or renamed its instance variable `schema_url`
- Model `EventType` deleted or renamed its instance variable `is_in_default_set`
- Model `ExtensionTopic` deleted or renamed its instance variable `description`
- Model `ExtensionTopic` deleted or renamed its instance variable `system_topic`
- Model `HybridConnectionEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
- Model `HybridConnectionEventSubscriptionDestination` deleted or renamed its instance variable `delivery_attribute_mappings`
- Model `JsonInputSchemaMapping` deleted or renamed its instance variable `id`
- Model `JsonInputSchemaMapping` deleted or renamed its instance variable `topic`
- Model `JsonInputSchemaMapping` deleted or renamed its instance variable `event_time`
- Model `JsonInputSchemaMapping` deleted or renamed its instance variable `event_type`
- Model `JsonInputSchemaMapping` deleted or renamed its instance variable `subject`
- Model `JsonInputSchemaMapping` deleted or renamed its instance variable `data_version`
- Model `MonitorAlertEventSubscriptionDestination` deleted or renamed its instance variable `severity`
- Model `MonitorAlertEventSubscriptionDestination` deleted or renamed its instance variable `description`
- Model `MonitorAlertEventSubscriptionDestination` deleted or renamed its instance variable `action_groups`
- Model `Namespace` deleted or renamed its instance variable `private_endpoint_connections`
- Model `Namespace` deleted or renamed its instance variable `provisioning_state`
- Model `Namespace` deleted or renamed its instance variable `topics_configuration`
- Model `Namespace` deleted or renamed its instance variable `topic_spaces_configuration`
- Model `Namespace` deleted or renamed its instance variable `is_zone_redundant`
- Model `Namespace` deleted or renamed its instance variable `public_network_access`
- Model `Namespace` deleted or renamed its instance variable `inbound_ip_rules`
- Model `Namespace` deleted or renamed its instance variable `minimum_tls_version_allowed`
- Model `NamespaceTopic` deleted or renamed its instance variable `provisioning_state`
- Model `NamespaceTopic` deleted or renamed its instance variable `publisher_type`
- Model `NamespaceTopic` deleted or renamed its instance variable `input_schema`
- Model `NamespaceTopic` deleted or renamed its instance variable `event_retention_in_days`
- Model `NamespaceTopicEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
...
- Model `NetworkSecurityPerimeterConfigurationIssues` deleted or renamed its instance variable `issue_type`
- Model `NetworkSecurityPerimeterConfigurationIssues` deleted or renamed its instance variable `severity`
- Model `NetworkSecurityPerimeterConfigurationIssues` deleted or renamed its instance variable `description`
- Model `NetworkSecurityPerimeterConfigurationIssues` deleted or renamed its instance variable `suggested_resource_ids`
- Model `NetworkSecurityPerimeterConfigurationIssues` deleted or renamed its instance variable `suggested_access_rules`
- Model `NetworkSecurityPerimeterProfileAccessRule` deleted or renamed its instance variable `direction`
- Model `NetworkSecurityPerimeterProfileAccessRule` deleted or renamed its instance variable `address_prefixes`
- Model `NetworkSecurityPerimeterProfileAccessRule` deleted or renamed its instance variable `subscriptions`
- Model `NetworkSecurityPerimeterProfileAccessRule` deleted or renamed its instance variable `network_security_perimeters`
- Model `NetworkSecurityPerimeterProfileAccessRule` deleted or renamed its instance variable `fully_qualified_domain_names`
- Model `NetworkSecurityPerimeterProfileAccessRule` deleted or renamed its instance variable `email_addresses`
- Model `NetworkSecurityPerimeterProfileAccessRule` deleted or renamed its instance variable `phone_numbers`
- Model `PartnerConfiguration` deleted or renamed its instance variable `partner_authorization`
- Model `PartnerConfiguration` deleted or renamed its instance variable `provisioning_state`
...
- Model `PartnerDestination` deleted or renamed its instance variable `partner_registration_immutable_id`
- Model `PartnerDestination` deleted or renamed its instance variable `endpoint_service_context`
- Model `PartnerDestination` deleted or renamed its instance variable `expiration_time_if_not_activated_utc`
- Model `PartnerDestination` deleted or renamed its instance variable `provisioning_state`
- Model `PartnerDestination` deleted or renamed its instance variable `activation_state`
- Model `PartnerDestination` deleted or renamed its instance variable `endpoint_base_url`
- Model `PartnerDestination` deleted or renamed its instance variable `message_for_activation`
- Model `PartnerEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
- Model `PartnerNamespace` deleted or renamed its instance variable `private_endpoint_connections`
- Model `PartnerNamespace` deleted or renamed its instance variable `provisioning_state`
- Model `PartnerNamespace` deleted or renamed its instance variable `partner_registration_fully_qualified_id`
- Model `PartnerNamespace` deleted or renamed its instance variable `minimum_tls_version_allowed`
- Model `PartnerNamespace` deleted or renamed its instance variable `endpoint`
- Model `PartnerNamespace` deleted or renamed its instance variable `public_network_access`
- Model `PartnerNamespace` deleted or renamed its instance variable `inbound_ip_rules`
- Model `PartnerNamespace` deleted or renamed its instance variable `disable_local_auth`
- Model `PartnerNamespace` deleted or renamed its instance variable `partner_topic_routing_mode`
...
- Model `PartnerRegistration` deleted or renamed its instance variable `provisioning_state`
- Model `PartnerRegistration` deleted or renamed its instance variable `partner_registration_immutable_id`
- Model `PartnerTopic` deleted or renamed its instance variable `partner_registration_immutable_id`
- Model `PartnerTopic` deleted or renamed its instance variable `source`
- Model `PartnerTopic` deleted or renamed its instance variable `event_type_info`
- Model `PartnerTopic` deleted or renamed its instance variable `expiration_time_if_not_activated_utc`
- Model `PartnerTopic` deleted or renamed its instance variable `provisioning_state`
- Model `PartnerTopic` deleted or renamed its instance variable `activation_state`
- Model `PartnerTopic` deleted or renamed its instance variable `partner_topic_friendly_description`
- Model `PartnerTopic` deleted or renamed its instance variable `message_for_activation`
- Model `PermissionBinding` deleted or renamed its instance variable `description`
- Model `PermissionBinding` deleted or renamed its instance variable `topic_space_name`
- Model `PermissionBinding` deleted or renamed its instance variable `permission`
- Model `PermissionBinding` deleted or renamed its instance variable `client_group_name`
- Model `PermissionBinding` deleted or renamed its instance variable `provisioning_state`
...
- Model `PrivateLinkResource` deleted or renamed its instance variable `display_name`
...
- Model `ServiceBusQueueEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
- Model `ServiceBusQueueEventSubscriptionDestination` deleted or renamed its instance variable `delivery_attribute_mappings`
- Model `ServiceBusTopicEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
- Model `ServiceBusTopicEventSubscriptionDestination` deleted or renamed its instance variable `delivery_attribute_mappings`
- Model `StaticDeliveryAttributeMapping` deleted or renamed its instance variable `value`
- Model `StaticDeliveryAttributeMapping` deleted or renamed its instance variable `is_secret`
- Model `StorageBlobDeadLetterDestination` deleted or renamed its instance variable `resource_id`
- Model `StorageBlobDeadLetterDestination` deleted or renamed its instance variable `blob_container_name`
- Model `StorageQueueEventSubscriptionDestination` deleted or renamed its instance variable `resource_id`
- Model `StorageQueueEventSubscriptionDestination` deleted or renamed its instance variable `queue_name`
- Model `StorageQueueEventSubscriptionDestination` deleted or renamed its instance variable `queue_message_time_to_live_in_seconds`
...
- Model `Subscription` deleted or renamed its instance variable `provisioning_state`
- Model `Subscription` deleted or renamed its instance variable `delivery_configuration`
- Model `Subscription` deleted or renamed its instance variable `event_delivery_schema`
- Model `Subscription` deleted or renamed its instance variable `filters_configuration`
- Model `Subscription` deleted or renamed its instance variable `expiration_time_utc`
- Model `Subscription` deleted or renamed its instance variable `tags`
...
- Model `SystemTopic` deleted or renamed its instance variable `provisioning_state`
- Model `SystemTopic` deleted or renamed its instance variable `source`
- Model `SystemTopic` deleted or renamed its instance variable `topic_type`
- Model `SystemTopic` deleted or renamed its instance variable `metric_resource_id`
- Model `SystemTopic` deleted or renamed its instance variable `encryption`
- Model `SystemTopic` deleted or renamed its instance variable `platform_capabilities`
- Model `Topic` deleted or renamed its instance variable `private_endpoint_connections`
- Model `Topic` deleted or renamed its instance variable `provisioning_state`
- Model `Topic` deleted or renamed its instance variable `endpoint`
- Model `Topic` deleted or renamed its instance variable `event_type_info`
- Model `Topic` deleted or renamed its instance variable `minimum_tls_version_allowed`
- Model `Topic` deleted or renamed its instance variable `input_schema`
- Model `Topic` deleted or renamed its instance variable `input_schema_mapping`
- Model `Topic` deleted or renamed its instance variable `metric_resource_id`
- Model `Topic` deleted or renamed its instance variable `public_network_access`
- Model `Topic` deleted or renamed its instance variable `inbound_ip_rules`
- Model `Topic` deleted or renamed its instance variable `disable_local_auth`
- Model `Topic` deleted or renamed its instance variable `data_residency_boundary`
- Model `Topic` deleted or renamed its instance variable `encryption`
- Model `Topic` deleted or renamed its instance variable `platform_capabilities`
- Model `TopicSpace` deleted or renamed its instance variable `description`
- Model `TopicSpace` deleted or renamed its instance variable `topic_templates`
- Model `TopicSpace` deleted or renamed its instance variable `provisioning_state`
...
- Model `VerifiedPartner` deleted or renamed its instance variable `partner_registration_immutable_id`
- Model `VerifiedPartner` deleted or renamed its instance variable `organization_name`
- Model `VerifiedPartner` deleted or renamed its instance variable `partner_display_name`
- Model `VerifiedPartner` deleted or renamed its instance variable `partner_topic_details`
- Model `VerifiedPartner` deleted or renamed its instance variable `partner_destination_details`
- Model `VerifiedPartner` deleted or renamed its instance variable `provisioning_state`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `endpoint_url`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `endpoint_base_url`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `max_events_per_batch`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `preferred_batch_size_in_kilobytes`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `azure_active_directory_tenant_id`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `azure_active_directory_application_id_or_uri`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `delivery_attribute_mappings`
- Model `WebHookEventSubscriptionDestination` deleted or renamed its instance variable `minimum_tls_version_allowed`
