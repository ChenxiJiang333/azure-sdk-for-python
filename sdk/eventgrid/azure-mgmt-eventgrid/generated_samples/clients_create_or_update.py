...
# USAGE
    python clients_create_or_update.py
...
def main():
    ...
    response = client.clients.begin_create_or_update(
...
# x-ms-original-file: specification/eventgrid/resource-manager/Microsoft.EventGrid/EventGrid/preview/2025-07-15-preview/examples/Clients_CreateOrUpdate.json
