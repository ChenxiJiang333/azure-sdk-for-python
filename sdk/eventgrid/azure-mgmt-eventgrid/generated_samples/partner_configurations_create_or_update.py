...
# USAGE
    python partner_configurations_create_or_update.py
...
# x-ms-original-file: specification/eventgrid/resource-manager/Microsoft.EventGrid/EventGrid/preview/2025-07-15-preview/examples/PartnerConfigurations_CreateOrUpdate.json
