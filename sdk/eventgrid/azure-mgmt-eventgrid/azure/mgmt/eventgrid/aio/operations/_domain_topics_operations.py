...
class DomainTopicsOperations:
    ...
    def list_by_domain(
        ...
        **kwargs: Any
    ) -> AsyncItemPaged["_models.DomainTopic"]:
        """List domain topics.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.eventgrid.models.DomainTopic]
    ...
    async def begin_create_or_update(
        ...
        :param domain_topic_name: Name of the topic. Required.
        :type domain_topic_name: str
        :return: An instance of AsyncLROPoller that returns either DomainTopic or the result of
         cls(response)
        ...
        if cont_token:
            return AsyncLROPoller[_models.DomainTopic].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[_models.DomainTopic](
