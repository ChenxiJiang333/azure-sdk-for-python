...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.attestation import AttestationClient
...
class TestAttestationPrivateEndpointConnectionsOperations(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(AttestationClient)
