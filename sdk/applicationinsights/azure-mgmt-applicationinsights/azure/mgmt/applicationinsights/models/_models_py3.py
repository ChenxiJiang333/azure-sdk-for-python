...
class AnnotationError(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype innererror: ~azure.mgmt.applicationinsights.models.InnerError
        """
        super().__init__(**kwargs)
        self.code = code
...
class AnnotationsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.Annotation]
    """
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword application_type: Type of application being monitored. Known values are: "web" and
         "other".
        :paramtype application_type: str or ~azure.mgmt.applicationinsights.models.ApplicationType
        :keyword flow_type: Used by the Application Insights system to determine what kind of flow this
         component was created by. This is to be set to 'Bluefield' when creating/updating a component
         via the REST API. "Bluefield"
        :paramtype flow_type: str or ~azure.mgmt.applicationinsights.models.FlowType
        :keyword request_source: Describes what tool created this Application Insights component.
         Customers using this API should set this to the default 'rest'. "rest"
        :paramtype request_source: str or ~azure.mgmt.applicationinsights.models.RequestSource
        ...
        :keyword ingestion_mode: Indicates the flow of the ingestion. Known values are:
         "ApplicationInsights", "ApplicationInsightsWithDiagnosticSettings", and "LogAnalytics".
        :paramtype ingestion_mode: str or ~azure.mgmt.applicationinsights.models.IngestionMode
...
class ApplicationInsightsComponentAnalyticsItem(_serialization.Model):  # pylint: disable=name-too-long
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype type: str or ~azure.mgmt.applicationinsights.models.ItemType
...
class ApplicationInsightsComponentAPIKeyListResult(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.ApplicationInsightsComponentAPIKey]
    """
    ...
    def __init__(self, *, value: list["_models.ApplicationInsightsComponentAPIKey"], **kwargs: Any) -> None:
        ...
        :paramtype value:
         list[~azure.mgmt.applicationinsights.models.ApplicationInsightsComponentAPIKey]
        """
        super().__init__(**kwargs)
        self.value = value
...
class ApplicationInsightsComponentListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.ApplicationInsightsComponent]
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.applicationinsights.models.ApplicationInsightsComponent]
...
class ApplicationInsightsWebTestLocationsListResult(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype value:
     list[~azure.mgmt.applicationinsights.models.ApplicationInsightsComponentWebTestLocation]
    """
...
class ComponentPurgeBody(_serialization.Model):
    ...
    def __init__(self, *, table: str, filters: list["_models.ComponentPurgeBodyFilters"], **kwargs: Any) -> None:
        ...
        :paramtype filters: list[~azure.mgmt.applicationinsights.models.ComponentPurgeBodyFilters]
        """
        super().__init__(**kwargs)
        self.table = table
...
class ComponentPurgeStatusResponse(_serialization.Model):
    ...
    def __init__(self, *, status: Union[str, "_models.PurgeState"], **kwargs: Any) -> None:
        ...
        :paramtype status: str or ~azure.mgmt.applicationinsights.models.PurgeState
        """
        super().__init__(**kwargs)
        self.status = status
...
class DeletedWorkbookResource(TrackedResourceAutoGenerated):
    """An azure resource object.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype kind: str or ~azure.mgmt.applicationinsights.models.WorkbookSharedTypeKind
        :keyword etag: Resource etag.
        :paramtype etag: str
        """
...
class DeletedWorkbookError(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.DeletedWorkbookErrorDefinition"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.applicationinsights.models.DeletedWorkbookErrorDefinition
        """
        super().__init__(**kwargs)
        self.error = error
...
class DeletedWorkbooksListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.DeletedWorkbook]
    :ivar next_link:
    :vartype next_link: str
    """
...
class ErrorResponse(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype details: list[~azure.mgmt.applicationinsights.models.ErrorFieldContract]
        """
        super().__init__(**kwargs)
        self.code = code
        self.message = message
...
class ErrorResponseComponents(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.ErrorResponseComponentsError"] = None, **kwargs: Any) -> None:
        ...
        :keyword error: Error response indicates Insights service is not able to process the incoming
         request. The reason is provided in the error message.
        :paramtype error: ~azure.mgmt.applicationinsights.models.ErrorResponseComponentsError
        """
        super().__init__(**kwargs)
        self.error = error
...
class ErrorResponseLinkedStorage(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.ErrorResponseLinkedStorageError"] = None, **kwargs: Any) -> None:
        ...
        :keyword error: Error response indicates Insights service is not able to process the incoming
         request. The reason is provided in the error message.
        :paramtype error: ~azure.mgmt.applicationinsights.models.ErrorResponseLinkedStorageError
        """
        super().__init__(**kwargs)
        self.error = error
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: Type of managed service identity (where both SystemAssigned and UserAssigned
         ...
         "SystemAssigned,UserAssigned".
        :paramtype type: str or ~azure.mgmt.applicationinsights.models.ManagedServiceIdentityType
...
class Operation(_serialization.Model):
    ...
    def __init__(
        ...
        :paramtype display: ~azure.mgmt.applicationinsights.models.OperationDisplay
        """
        super().__init__(**kwargs)
        self.name = name
...
class OperationListResult(_serialization.Model):
    """Result of the request to list Azure Workbooks operations. It contains a list of operations and
    a URL link to get the next set of results.

    :ivar value: List of Workbook operations supported by the Microsoft.Insights resource provider.
    :vartype value: list[~azure.mgmt.applicationinsights.models.Operation]
    ...
    def __init__(
        ...
        :keyword value: List of Workbook operations supported by the Microsoft.Insights resource
         provider.
        :paramtype value: list[~azure.mgmt.applicationinsights.models.Operation]
...
class OperationLive(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.applicationinsights.models.OperationInfo
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.applicationinsights.models.OperationInfo
...
class OperationsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.OperationLive]
    :ivar next_link: URL to get the next set of operation list results if there are any.
    :vartype next_link: str
    """
    ...
    def __init__(
        ...
        :paramtype value: list[~azure.mgmt.applicationinsights.models.OperationLive]
        :keyword next_link: URL to get the next set of operation list results if there are any.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword created_by_type: The type of identity that created the resource. Known values are:
         "User", "Application", "ManagedIdentity", and "Key".
        :paramtype created_by_type: str or ~azure.mgmt.applicationinsights.models.CreatedByType
        ...
        :paramtype last_modified_by_type: str or ~azure.mgmt.applicationinsights.models.CreatedByType
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword kind: The kind of WebTest that this web test watches. Choices are ping, multistep and
         standard. Known values are: "ping", "multistep", and "standard".
        :paramtype kind: str or ~azure.mgmt.applicationinsights.models.WebTestKind
        ...
        :keyword web_test_kind: The kind of web test this is, valid choices are ping, multistep and
         standard. Known values are: "ping", "multistep", and "standard".
        :paramtype web_test_kind: str or ~azure.mgmt.applicationinsights.models.WebTestKind
        ...
        :paramtype locations: list[~azure.mgmt.applicationinsights.models.WebTestGeolocation]
        :keyword configuration: An XML configuration specification for a WebTest.
        :paramtype configuration: ~azure.mgmt.applicationinsights.models.WebTestPropertiesConfiguration
        :keyword request: The collection of request properties.
        :paramtype request: ~azure.mgmt.applicationinsights.models.WebTestPropertiesRequest
...
class WebTestListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.WebTest]
...
class WebTestPropertiesRequest(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype headers: list[~azure.mgmt.applicationinsights.models.HeaderField]
...
class WorkbookResource(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype identity: ~azure.mgmt.applicationinsights.models.WorkbookResourceIdentity
        :keyword kind: The kind of workbook. Only valid value is shared. "shared"
        :paramtype kind: str or ~azure.mgmt.applicationinsights.models.WorkbookSharedTypeKind
        :keyword etag: Resource etag.
        :paramtype etag: str
...
class WorkbookError(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.WorkbookErrorDefinition"] = None, **kwargs: Any) -> None:
        """
        :keyword error: The error details.
        :paramtype error: ~azure.mgmt.applicationinsights.models.WorkbookErrorDefinition
        """
        super().__init__(**kwargs)
        self.error = error
...
class WorkbooksListResult(_serialization.Model):
    ...
    :ivar value: An array of workbooks.
    :vartype value: list[~azure.mgmt.applicationinsights.models.Workbook]
    :ivar next_link:
    :vartype next_link: str
    """
...
class WorkbookTemplate(WorkbookTemplateResource):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype galleries: list[~azure.mgmt.applicationinsights.models.WorkbookTemplateGallery]
...
class WorkbookTemplateError(_serialization.Model):
    ...
    def __init__(self, *, error: Optional["_models.WorkbookTemplateErrorBody"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.mgmt.applicationinsights.models.WorkbookTemplateErrorBody
        """
        super().__init__(**kwargs)
        self.error = error
...
class WorkbookTemplatesListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.WorkbookTemplate]
    """
...
class WorkbookUpdateParameters(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword kind: The kind of workbook. Only valid value is shared. "shared"
        :paramtype kind: str or ~azure.mgmt.applicationinsights.models.WorkbookUpdateSharedTypeKind
        :keyword tags: Resource tags.
        :paramtype tags: dict[str, str]
        :keyword display_name: The user-defined name (display name) of the workbook.
        :paramtype display_name: str
...
class WorkItemConfigurationsListResult(_serialization.Model):
    ...
    :vartype value: list[~azure.mgmt.applicationinsights.models.WorkItemConfiguration]
    """
