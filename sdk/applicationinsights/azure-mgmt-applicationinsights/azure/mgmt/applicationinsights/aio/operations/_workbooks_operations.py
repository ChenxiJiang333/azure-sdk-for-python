...
class WorkbooksOperations:
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type workbook_properties: ~azure.mgmt.applicationinsights.models.Workbook or IO[bytes]
        :param source_id: Azure Resource Id that will fetch all linked workbooks. Default value is
         None.
        :type source_id: str
        :return: Workbook or the result of cls(response)
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type workbook_update_parameters:
         ~azure.mgmt.applicationinsights.models.WorkbookUpdateParameters or IO[bytes]
        :return: Workbook or the result of cls(response)
        :rtype: ~azure.mgmt.applicationinsights.models.Workbook
        :raises ~azure.core.exceptions.HttpResponseError:
        """
