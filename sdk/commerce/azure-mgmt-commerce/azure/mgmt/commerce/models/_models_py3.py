...
class UsageAggregationListResult(_serialization.Model):
    ...
    :ivar value: The UsageAggregation items on this page. Required.
    ...
    def __init__(
        self, *, value: list["_models.UsageAggregation"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The UsageAggregation items on this page. Required.
