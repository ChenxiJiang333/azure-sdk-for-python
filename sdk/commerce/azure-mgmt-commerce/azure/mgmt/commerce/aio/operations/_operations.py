...
class UsageAggregatesOperations:
    ...
    def list(
        ...
        **kwargs: Any
        ...
        async def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(List[_models.UsageAggregation], deserialized.get("value", []))
            if cls:
    ...
    async def begin_list(
        ...
        *,
        ...
        continuation_token_parameter: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncLROPoller[List[_models.UsageAggregation]]:
        """Query aggregated Azure subscription consumption data for a date range.
        ...
        :keyword continuation_token_parameter: Used when a continuation token string is provided in the
         ...
         Default value is None.
        :paramtype continuation_token_parameter: str
        :return: An instance of AsyncLROPoller that returns list of UsageAggregation
        :rtype: ~azure.core.polling.AsyncLROPoller[list[~azure.mgmt.commerce.models.UsageAggregation]]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
        ...
        def get_long_running_output(pipeline_response):
            response = pipeline_response.http_response
            deserialized = _deserialize(List[_models.UsageAggregation], response.json().get("value", {}))
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if cont_token:
            return AsyncLROPoller[List[_models.UsageAggregation]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return AsyncLROPoller[List[_models.UsageAggregation]](
