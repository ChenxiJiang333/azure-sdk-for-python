...
class AutomationClient:  # pylint: disable=too-many-instance-attributes
    ...
    :vartype automation_accounts: azure.mgmt.automation.operations.AutomationAccountsOperations
    ...
    :keyword api_version: The API version to use for this operation. Default value is "2024-10-23".
