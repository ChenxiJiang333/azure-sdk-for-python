...
- Deleted model `JobListResultV2`/`NodeCounts`/`RunbookCreateOrUpdateDraftParameters`/`RunbookCreateOrUpdateDraftProperties`/`SourceControlSyncJobStreamsListBySyncJob` which actually were not used by SDK users
