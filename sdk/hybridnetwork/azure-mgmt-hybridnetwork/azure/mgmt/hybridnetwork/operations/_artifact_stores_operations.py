...
def build_add_network_fabric_controller_end_points_request(  # pylint: disable=name-too-long
    resource_group_name: str, publisher_name: str, artifact_store_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_approve_private_end_points_request(
    resource_group_name: str, publisher_name: str, artifact_store_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_delete_network_fabric_controller_end_points_request(  # pylint: disable=name-too-long
    resource_group_name: str, publisher_name: str, artifact_store_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_network_fabric_controller_private_end_points_request(  # pylint: disable=name-too-long
    resource_group_name: str, publisher_name: str, artifact_store_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_list_private_end_points_request(
    resource_group_name: str, publisher_name: str, artifact_store_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_remove_private_end_points_request(
    resource_group_name: str, publisher_name: str, artifact_store_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ArtifactStoresOperations:
    ...
    def begin_list_network_fabric_controller_private_end_points(  # pylint: disable=name-too-long
        self, resource_group_name: str, publisher_name: str, artifact_store_name: str, **kwargs: Any
    ) -> LROPoller[ItemPaged["_models.ArtifactStoreNetworkFabricControllerEndPoints"]]:
        ...
        return LROPoller[ItemPaged["_models.ArtifactStoreNetworkFabricControllerEndPoints"]](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    def begin_list_private_end_points(
        self, resource_group_name: str, publisher_name: str, artifact_store_name: str, **kwargs: Any
    ) -> LROPoller[ItemPaged["_models.ArtifactStorePrivateEndPointsFormat"]]:
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[ItemPaged["_models.ArtifactStorePrivateEndPointsFormat"]].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[ItemPaged["_models.ArtifactStorePrivateEndPointsFormat"]](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
