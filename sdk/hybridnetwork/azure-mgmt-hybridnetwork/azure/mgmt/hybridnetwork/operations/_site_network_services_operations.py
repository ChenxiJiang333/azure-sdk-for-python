...
def build_cancel_operation_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    _url = kwargs.pop(
        "template_url",
        "/subscriptions/{subscriptionId}/providers/Microsoft.HybridNetwork/cancelSiteNetworkServiceOperation",
    )
...
class SiteNetworkServicesOperations:
    ...
    def _cancel_operation_initial(
        self, parameters: Union[_models.CancelInformation, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        ...
        if isinstance(parameters, (IOBase, bytes)):
            ...
            _json = self._serialize.body(parameters, "CancelInformation")

        _request = build_cancel_operation_request(
    ...
    def begin_cancel_operation(
        ...
        :param parameters: The SiteNetworkService detail and an optional operation which defaults to
         'Put'. Required.
        :type parameters: ~Microsoft.HybridNetwork.models.CancelInformation
    ...
    def begin_cancel_operation(
        ...
        :param parameters: The SiteNetworkService detail and an optional operation which defaults to
         'Put'. Is either a CancelInformation type or a IO[bytes] type. Required.
        :type parameters: ~Microsoft.HybridNetwork.models.CancelInformation or IO[bytes]
        :return: An instance of LROPoller that returns either None or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[None]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
