...
class ArtifactStoresOperations:
    ...
    async def begin_list_network_fabric_controller_private_end_points(  # pylint: disable=name-too-long
        self, resource_group_name: str, publisher_name: str, artifact_store_name: str, **kwargs: Any
    ) -> AsyncLROPoller[AsyncItemPaged["_models.ArtifactStoreNetworkFabricControllerEndPoints"]]:
        ...
        return AsyncLROPoller[AsyncItemPaged["_models.ArtifactStoreNetworkFabricControllerEndPoints"]](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
    ...
    async def begin_list_private_end_points(
        self, resource_group_name: str, publisher_name: str, artifact_store_name: str, **kwargs: Any
    ) -> AsyncLROPoller[AsyncItemPaged["_models.ArtifactStorePrivateEndPointsFormat"]]:
        ...
        return AsyncLROPoller[AsyncItemPaged["_models.ArtifactStorePrivateEndPointsFormat"]](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )
