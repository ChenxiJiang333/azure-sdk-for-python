...
class SubscriptionOperations:
    ...
    @distributed_trace_async
    async def cancel(self, **kwargs: Any) -> _models.CanceledSubscriptionId:
    ...
    @distributed_trace_async
    async def enable(self, **kwargs: Any) -> _models.EnabledSubscriptionId:
    ...
    @distributed_trace_async
    async def rename(
        self, body: Union[_models.SubscriptionName, IO[bytes]], **kwargs: Any
    ) -> _models.RenamedSubscriptionId:
        """The operation to rename a subscription.
