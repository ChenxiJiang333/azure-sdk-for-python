...
class HierarchySettingsOperations:
    ...
    @distributed_trace
    def list(self, group_id: str, **kwargs: Any) -> AsyncItemPaged["_models.HierarchySettingsInfo"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.managementgroups.models.HierarchySettingsInfo]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
