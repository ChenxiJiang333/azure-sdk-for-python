...
class TestDBforPostgreSQLConfigurationsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_configurations_begin_put(self, resource_group):
        response = await (
            await self.client.configurations.begin_put(
                resource_group_name=resource_group.name,
                server_name="str",
                configuration_name="str",
                parameters={
