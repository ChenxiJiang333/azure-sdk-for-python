...
class AdministratorMicrosoftEntraList(_serialization.Model):
    ...
    :ivar value: The AdministratorMicrosoftEntra items on this page. Required.
    ...
    def __init__(
        self, *, value: list["_models.AdministratorMicrosoftEntra"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The AdministratorMicrosoftEntra items on this page. Required.
        :paramtype value:
...
class AdvancedThreatProtectionSettingsList(_serialization.Model):
    ...
    :ivar value: The AdvancedThreatProtectionSettingsModel items on this page. Required.
    :vartype value:
...
class BackupAutomaticAndOnDemandList(_serialization.Model):
    ...
    :ivar value: The BackupAutomaticAndOnDemand items on this page. Required.
    ...
    def __init__(
        self, *, value: list["_models.BackupAutomaticAndOnDemand"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The BackupAutomaticAndOnDemand items on this page. Required.
...
class BackupForPatch(_serialization.Model):
    ...
    _validation = {
        "geo_redundant_backup": {"readonly": True},
        "earliest_restore_date": {"readonly": True},
    }
    ...
    def __init__(self, *, backup_retention_days: Optional[int] = None, **kwargs: Any) -> None:
        """
        :keyword backup_retention_days: Backup retention days for the server.
        :paramtype backup_retention_days: int
        """
        super().__init__(**kwargs)
        self.backup_retention_days = backup_retention_days
        self.geo_redundant_backup: Optional[Union[str, "_models.GeographicallyRedundantBackup"]] = None
        self.earliest_restore_date: Optional[datetime.datetime] = None
...
class CapturedLogList(_serialization.Model):
    ...
    :ivar value: The CapturedLog items on this page. Required.
    ...
    def __init__(self, *, value: list["_models.CapturedLog"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The CapturedLog items on this page. Required.
...
class DataEncryption(_serialization.Model):
    ...
    _validation = {
        "primary_encryption_key_status": {"readonly": True},
        "geo_backup_encryption_key_status": {"readonly": True},
    }
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.type = type
        self.primary_encryption_key_status: Optional[Union[str, "_models.EncryptionKeyStatus"]] = None
        self.geo_backup_encryption_key_status: Optional[Union[str, "_models.EncryptionKeyStatus"]] = None
...
class LtrServerBackupOperationList(_serialization.Model):
    ...
    :ivar value: The BackupsLongTermRetentionOperation items on this page. Required.
    :vartype value:
    ...
    def __init__(
        self,
        *,
        value: list["_models.BackupsLongTermRetentionOperation"],
        next_link: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword value: The BackupsLongTermRetentionOperation items on this page. Required.
        :paramtype value:
         list[~azure.mgmt.postgresqlflexibleservers.models.BackupsLongTermRetentionOperation]
        :keyword next_link: The link to the next page of items.
        :paramtype next_link: str
...
class MigrationList(_serialization.Model):
    ...
    :ivar value: The Migration items on this page. Required.
...
class ObjectRecommendationList(_serialization.Model):
    ...
    :ivar value: The ObjectRecommendation items on this page. Required.
    ...
    def __init__(
        self, *, value: list["_models.ObjectRecommendation"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The ObjectRecommendation items on this page. Required.
...
class QuotaUsageList(_serialization.Model):
    ...
    :ivar value: The QuotaUsage items on this page. Required.
...
class ServerForPatch(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.identity = identity
        self.tags = tags
        self.administrator_login: Optional[str] = None
        self.administrator_login_password = administrator_login_password
        self.version = version
        self.storage = storage
        self.backup = backup
...
class TuningOptionsList(_serialization.Model):
    ...
    :ivar value: The TuningOptions items on this page. Required.
    ...
    def __init__(self, *, value: list["_models.TuningOptions"], next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword value: The TuningOptions items on this page. Required.
...
class VirtualEndpointsList(_serialization.Model):
    ...
    :ivar value: The VirtualEndpoint items on this page. Required.
    ...
    def __init__(
        self, *, value: list["_models.VirtualEndpoint"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The VirtualEndpoint items on this page. Required.
