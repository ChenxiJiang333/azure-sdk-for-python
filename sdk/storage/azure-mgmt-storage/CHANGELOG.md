...
### Breaking Changes
  ...
  - Method `StorageAccountsOperations.begin_failover` parameter `failover_type` changed default value from `str` to `none`
  ...
  - Method `StorageAccountsOperations.list_keys` parameter `expand` changed default value from `str` to `none`
