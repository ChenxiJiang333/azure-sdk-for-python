...
### Breaking Changes
  ...
  - Moved enum value `ACCEPTED`  from enum `ProvisioningState` to new enum `StorageTaskAssignmentProvisioningState`
  - Moved enum value `CANCELED`  from enum `ProvisioningState` to new enum `StorageTaskAssignmentProvisioningState`
  - Moved enum value `DELETING`  from enum `ProvisioningState` to new enum `StorageTaskAssignmentProvisioningState`
  - Moved enum value `FAILED`  from enum `ProvisioningState` to new enum `StorageTaskAssignmentProvisioningState`
  - Moved enum value `VALIDATE_SUBSCRIPTION_QUOTA_BEGIN`  from enum `ProvisioningState` to new enum `StorageTaskAssignmentProvisioningState`
  - Moved enum value `VALIDATE_SUBSCRIPTION_QUOTA_END`  from enum `ProvisioningState` to new enum `StorageTaskAssignmentProvisioningState`
