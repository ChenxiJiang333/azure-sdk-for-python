...
# USAGE
    python put_storage_task_assignment_required_properties.py
...
# x-ms-original-file: 2025-06-01/storageTaskAssignmentsCrud/PutStorageTaskAssignmentRequiredProperties.json
