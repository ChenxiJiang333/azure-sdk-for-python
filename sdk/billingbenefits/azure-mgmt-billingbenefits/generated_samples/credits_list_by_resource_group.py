...
# USAGE
    python credits_list_by_resource_group.py
...
def main():
    ...
    response = client.credits.list_by_resource_group(
...
# x-ms-original-file: 2025-05-01-preview/CreditsListByResourceGroup.json
