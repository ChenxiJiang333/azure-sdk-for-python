...
# USAGE
    python macc_no_milestones_commitment_update.py
...
def main():
    ...
    response = client.maccs.begin_update(
        ...
        body={"properties": {"commitment": {"amount": 40000, "currencyCode": "USD", "grain": "FullTerm"}}},
    ).result()
    print(response)


# x-ms-original-file: 2025-05-01-preview/MaccNoMilestonesCommitmentUpdate.json
