...
# USAGE
    python macc_unsuppress_automatic_shortfall.py
...
def main():
    ...
    response = client.maccs.begin_update(
        ...
        body={"properties": {"automaticShortfall": "Enabled", "automaticShortfallSuppressReason": None}},
    ).result()
    print(response)


# x-ms-original-file: 2025-05-01-preview/MaccUnsuppressAutomaticShortfall.json
