...
# USAGE
    python macc_validate_update_commitment_end_at_contributor_rule.py
...
# x-ms-original-file: 2025-05-01-preview/MaccValidateUpdateCommitmentEndAtContributorRule.json
