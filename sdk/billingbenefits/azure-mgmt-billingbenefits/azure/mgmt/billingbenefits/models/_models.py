...
class ArmManagedServiceIdentity(_Model):
...
class Award(_Model):
    ...
    :ivar duration: Duration for which the benefit is active. Will be in format P{int}M or P{int}Y.
     Any values representing up to 12 years are valid. Upper limit examples: P144M, P12Y.
    ...
    """Duration for which the benefit is active. Will be in format P{int}M or P{int}Y. Any values
     representing up to 12 years are valid. Upper limit examples: P144M, P12Y."""
...
class BillingPlanInformation(_Model):
    ...
    :vartype next_payment_due_date: ~datetime.datetime
    :ivar transactions:
    ...
    start_date: Optional[datetime.datetime] = rest_field(
        name="startDate", visibility=["read", "create", "update", "delete", "query"], format="rfc7231"
    )
    """Date when the billing plan has started."""
    next_payment_due_date: Optional[datetime.datetime] = rest_field(
        name="nextPaymentDueDate", visibility=["read", "create", "update", "delete", "query"], format="rfc7231"
    )
    ...
    def __init__(
        ...
        *,
        ...
        next_payment_due_date: Optional[datetime.datetime] = None,
...
class ConditionalCredit(TrackedResource):
    ...
    :vartype identity: ~azure.mgmt.billingbenefits.models.ArmManagedServiceIdentity
    ...
    """The etag field is *not* required. If it is provided in the response body, it must also be
     ...
     header fields."""
    identity: Optional["_models.ArmManagedServiceIdentity"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Managed service identity (system assigned and/or user assigned identities)."""
    ...
    def __init__(
        ...
        *,
        ...
        identity: Optional["_models.ArmManagedServiceIdentity"] = None,
...
class ContributorConditionalCreditProperties(ConditionalCreditProperties, discriminator="Contributor"):
    ...
    :ivar entity_type: Type of conditional credit entity. Required.
    ...
    """Type of conditional credit entity. Required."""
...
class CreditReason(_Model):
    ...
    code: Optional[float] = rest_field(visibility=["read"])
...
class PaymentDetail(_Model):
    ...
    :vartype payment_date: ~datetime.datetime
    ...
    due_date: Optional[datetime.datetime] = rest_field(
        name="dueDate", visibility=["read", "create", "update", "delete", "query"], format="rfc7231"
    )
    """Date when the payment needs to be done."""
    payment_date: Optional[datetime.datetime] = rest_field(
        name="paymentDate", visibility=["read", "create", "update", "delete", "query"], format="rfc7231"
    )
