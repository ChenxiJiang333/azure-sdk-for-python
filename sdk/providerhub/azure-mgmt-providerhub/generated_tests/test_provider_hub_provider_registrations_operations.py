...
class TestProviderHubProviderRegistrationsOperations(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_provider_registrations_generate_manifest(self, resource_group):
        response = self.client.provider_registrations.generate_manifest(
            provider_namespace="str",
        )
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_provider_registrations_checkin_manifest(self, resource_group):
        response = self.client.provider_registrations.checkin_manifest(
            provider_namespace="str",
