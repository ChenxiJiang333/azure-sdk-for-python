...
# USAGE
    python skus_delete_nested_resource_type_third.py
...
def main():
    ...
    client.skus.delete_nested_resource_type_third(
...
# x-ms-original-file: specification/providerhub/resource-manager/Microsoft.ProviderHub/stable/2024-09-01/examples/Skus_DeleteNestedResourceTypeThird.json
