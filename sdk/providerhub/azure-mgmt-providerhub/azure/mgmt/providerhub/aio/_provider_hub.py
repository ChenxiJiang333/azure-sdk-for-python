...
class ProviderHub(_ProviderHubOperationsMixin):  # pylint: disable=too-many-instance-attributes
    """Provider Hub.
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ProviderHubConfiguration(
