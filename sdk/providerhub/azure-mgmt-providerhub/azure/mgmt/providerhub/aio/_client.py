...
from .operations import (
    ...
    Operations,
    OperationsPutContentsOperations,
...
class ProviderHubClient:  # pylint: disable=too-many-instance-attributes
    """Provider Hub.
    ...
    :ivar operations_put_contents: OperationsPutContentsOperations operations
    :vartype operations_put_contents:
     azure.mgmt.providerhub.aio.operations.OperationsPutContentsOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = ProviderHubClientConfiguration(
        ...
        self.operations_put_contents = OperationsPutContentsOperations(
            self._client, self._config, self._serialize, self._deserialize
        )
