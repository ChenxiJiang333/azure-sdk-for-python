...
class AccessRuleProperties(_Model):
    ...
    :vartype subscriptions: list[~azure.mgmt.cosmosdb.models.AccessRulePropertiesSubscription]
...
class DataTransferDataSourceSink(_Model):
    ...
    CosmosMongoDataTransferDataSourceSink, CosmosMongoVCoreDataTransferDataSourceSink,
...
class BlobToCassandraRUCopyJobProperties(BaseCopyJobProperties, discriminator="AzureBlobStorageToCassandraRU"):
    ...
    :ivar job_type: Copy Job Type. Required.
...
class CassandraKeyspaceGetPropertiesResource(_Model):
...
class CassandraTableGetPropertiesResource(_Model):
...
class CassandraViewGetPropertiesResource(_Model):
...
class ClientEncryptionKeyGetPropertiesResource(_Model):
...
class CloudError(_Model):
    ...
    :vartype error: ~azure.mgmt.cosmosdb.models.CosmosDBErrorResult
    """

    error: Optional["_models.CosmosDBErrorResult"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    """Error Response."""
    ...
    def __init__(
        self,
        *,
        error: Optional["_models.CosmosDBErrorResult"] = None,
    ) -> None: ...
...
class ContinuousModeBackupPolicy(BackupPolicy, discriminator="Continuous"):
    ...
    :ivar type: Describes the mode of backups. Required.
...
class CosmosCassandraDataTransferDataSourceSink(
    DataTransferDataSourceSink, discriminator="CosmosDBCassandra"
):  # pylint: disable=name-too-long
...
class CosmosDBErrorResult(_Model):
    """Error Response.
...
class CosmosMongoDataTransferDataSourceSink(DataTransferDataSourceSink, discriminator="CosmosDBMongo"):
...
class CosmosSqlDataTransferDataSourceSink(DataTransferDataSourceSink, discriminator="CosmosDBSql"):
...
class DataMaskingPolicy(_Model):
    ...
    :vartype included_paths: list[~azure.mgmt.cosmosdb.models.DataMaskingPolicyIncludedPath]
    :ivar excluded_paths: List of JSON paths to exclude from masking.
    :vartype excluded_paths: list[~azure.mgmt.cosmosdb.models.DataMaskingPolicyExcludedPath]
    :ivar is_policy_enabled: Flag indicating whether the data masking policy is enabled.
    :vartype is_policy_enabled: bool
    """

    included_paths: Optional[list["_models.DataMaskingPolicyIncludedPath"]] = rest_field(
        name="includedPaths", visibility=["read", "create", "update", "delete", "query"]
    )
    """List of JSON paths to include in the masking policy."""
    excluded_paths: Optional[list["_models.DataMaskingPolicyExcludedPath"]] = rest_field(
    ...
    def __init__(
        self,
        *,
        included_paths: Optional[list["_models.DataMaskingPolicyIncludedPath"]] = None,
        excluded_paths: Optional[list["_models.DataMaskingPolicyExcludedPath"]] = None,
...
class DataMaskingPolicyExcludedPath(_Model):
...
class DataMaskingPolicyIncludedPath(_Model):
...
class DataTransferJobProperties(_Model):
    ...
    """Worker count."""
    error: Optional["_models.CosmosDBErrorResult"] = rest_field(visibility=["read"])
    """Error response for Faulted job."""
    duration: Optional[str] = rest_field(visibility=["read"])
    """Total Duration of Job."""
...
class DataTransferServiceResourceCreateUpdateProperties(
    ...
    :ivar instance_count: Instance count for the service.
    :vartype instance_count: int
    :ivar service_type: ServiceType for the service. Required.
...
class FleetspaceProperties(_Model):
    ...
    service_tier: Optional[Union[str, "_models.FleetspacePropertiesThroughputPoolConfigurationServiceTier"]] = (
        rest_field(name="serviceTier", visibility=["read", "create", "update", "delete", "query"])
    )
...
class GarnetClusterEndpoint(_Model):
...
class GarnetClusterProperties(_Model):
    ...
    :vartype end_points: list[~azure.mgmt.cosmosdb.models.GarnetClusterEndpoint]
    ...
    """Resource id of a subnet that this cluster's management service should have its network
     ...
     id>/resourceGroups/<resource group>/providers/Microsoft.Network/virtualNetworks/<virtual
     network>/subnets/<subnet>'."""
    end_points: Optional[list["_models.GarnetClusterEndpoint"]] = rest_field(name="endPoints", visibility=["read"])
...
class GarnetClusterResource(TrackedResource):
    ...
    :vartype properties: ~azure.mgmt.cosmosdb.models.GarnetClusterProperties
    :ivar identity: Identity for the resource.
    :vartype identity: ~azure.mgmt.cosmosdb.models.ManagedCassandraManagedServiceIdentity
    """

    properties: Optional["_models.GarnetClusterProperties"] = rest_field(
        visibility=["read", "create", "update", "delete", "query"]
    )
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[dict[str, str]] = None,
        properties: Optional["_models.GarnetClusterProperties"] = None,
        identity: Optional["_models.ManagedCassandraManagedServiceIdentity"] = None,
    ) -> None: ...
...
class GremlinDatabaseGetPropertiesResource(_Model):
...
class GremlinGraphGetPropertiesResource(_Model):
...
class MongoDBCollectionGetPropertiesResource(_Model):
...
class MongoDBDatabaseGetPropertiesResource(_Model):
...
class RestorableSqlContainerPropertiesResourceContainer(_Model):  # pylint: disable=name-too-long
    """Cosmos DB SQL container resource object.
...
class RestorableSqlDatabasePropertiesResourceDatabase(_Model):  # pylint: disable=name-too-long
    """Cosmos DB SQL database resource object.
...
class SqlContainerGetPropertiesResource(_Model):
...
class SqlDatabaseGetPropertiesResource(_Model):
...
class SqlStoredProcedureGetPropertiesResource(_Model):
...
class SqlTriggerGetPropertiesResource(_Model):
...
class SqlUserDefinedFunctionGetPropertiesResource(_Model):  # pylint: disable=name-too-long
...
class TableGetPropertiesResource(_Model):
...
class ThroughputSettingsGetPropertiesResource(_Model):
