...
- Model `CassandraRoleAssignmentResource` deleted or renamed its instance variable `role_definition_id`
- Model `CassandraRoleAssignmentResource` deleted or renamed its instance variable `scope`
- Model `CassandraRoleAssignmentResource` deleted or renamed its instance variable `principal_id`
- Model `CassandraRoleAssignmentResource` deleted or renamed its instance variable `provisioning_state`
- Model `CassandraRoleDefinitionResource` deleted or renamed its instance variable `id_properties_id`
- Model `CassandraRoleDefinitionResource` deleted or renamed its instance variable `role_name`
- Model `CassandraRoleDefinitionResource` deleted or renamed its instance variable `type_properties_type`
- Model `CassandraRoleDefinitionResource` deleted or renamed its instance variable `assignable_scopes`
- Model `CassandraRoleDefinitionResource` deleted or renamed its instance variable `permissions`
...
- Model `DatabaseAccountCreateUpdateParameters` deleted or renamed its instance variable `enable_all_versions_and_deletes_change_feed`
...
- Model `DatabaseAccountGetResults` deleted or renamed its instance variable `enable_all_versions_and_deletes_change_feed`
- Model `DatabaseAccountGetResults` deleted or renamed its instance variable `throughput_pool_dedicated_r_us`
- Model `DatabaseAccountGetResults` deleted or renamed its instance variable `throughput_pool_max_consumable_r_us`
...
- Model `DatabaseAccountUpdateParameters` deleted or renamed its instance variable `enable_all_versions_and_deletes_change_feed`
- Model `FleetAnalyticsResource` deleted or renamed its instance variable `provisioning_state`
- Model `FleetAnalyticsResource` deleted or renamed its instance variable `storage_location_type`
- Model `FleetAnalyticsResource` deleted or renamed its instance variable `storage_location_uri`
...
- Model `GremlinRoleAssignmentResource` deleted or renamed its instance variable `role_definition_id`
- Model `GremlinRoleAssignmentResource` deleted or renamed its instance variable `scope`
- Model `GremlinRoleAssignmentResource` deleted or renamed its instance variable `principal_id`
- Model `GremlinRoleAssignmentResource` deleted or renamed its instance variable `provisioning_state`
- Model `GremlinRoleDefinitionResource` deleted or renamed its instance variable `id_properties_id`
- Model `GremlinRoleDefinitionResource` deleted or renamed its instance variable `role_name`
- Model `GremlinRoleDefinitionResource` deleted or renamed its instance variable `type_properties_type`
- Model `GremlinRoleDefinitionResource` deleted or renamed its instance variable `assignable_scopes`
- Model `GremlinRoleDefinitionResource` deleted or renamed its instance variable `permissions`
...
- Model `MongoMIRoleAssignmentResource` deleted or renamed its instance variable `role_definition_id`
- Model `MongoMIRoleAssignmentResource` deleted or renamed its instance variable `scope`
- Model `MongoMIRoleAssignmentResource` deleted or renamed its instance variable `principal_id`
- Model `MongoMIRoleAssignmentResource` deleted or renamed its instance variable `provisioning_state`
- Model `MongoMIRoleDefinitionResource` deleted or renamed its instance variable `id_properties_id`
- Model `MongoMIRoleDefinitionResource` deleted or renamed its instance variable `role_name`
- Model `MongoMIRoleDefinitionResource` deleted or renamed its instance variable `type_properties_type`
- Model `MongoMIRoleDefinitionResource` deleted or renamed its instance variable `assignable_scopes`
- Model `MongoMIRoleDefinitionResource` deleted or renamed its instance variable `permissions`
...
- Model `PhysicalPartitionThroughputInfoResult` deleted or renamed its instance variable `resource`
...
- Model `TableRoleAssignmentResource` deleted or renamed its instance variable `role_definition_id`
- Model `TableRoleAssignmentResource` deleted or renamed its instance variable `scope`
- Model `TableRoleAssignmentResource` deleted or renamed its instance variable `principal_id`
- Model `TableRoleAssignmentResource` deleted or renamed its instance variable `provisioning_state`
- Model `TableRoleDefinitionResource` deleted or renamed its instance variable `id_properties_id`
- Model `TableRoleDefinitionResource` deleted or renamed its instance variable `role_name`
- Model `TableRoleDefinitionResource` deleted or renamed its instance variable `type_properties_type`
- Model `TableRoleDefinitionResource` deleted or renamed its instance variable `assignable_scopes`
- Model `TableRoleDefinitionResource` deleted or renamed its instance variable `permissions`
...
### Other Changes
  ...
  - Deleted model `ChaosFaultListResponse`/`CommandOutput`/`CopyJobFeedResults`/`DataTransferJobFeedResults`/`ListBackups`/`ListClusters`/`ListCommands`/`ListDataCenters`/`ListGarnetClusters`/`PartitionUsagesResult`/`UsagesResult` which actually were not used by SDK users
