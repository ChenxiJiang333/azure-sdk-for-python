...
class Search_management_request_options(_Model):
...
class SearchServiceProperties(_Model):
    ...
    """The number of replicas in the search service. If specified, it must be a value between 1 and 12
    ...
    """Sets options that control the availability of semantic search. This configuration is only
     possible for certain Azure AI Search SKUs in certain locations. Known values are: \"disabled\",
     \"free\", and \"standard\"."""
