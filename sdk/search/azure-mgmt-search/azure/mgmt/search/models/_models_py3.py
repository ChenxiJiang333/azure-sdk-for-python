...
class AccessRulePropertiesSubscriptionsItemAutoGenerated(_serialization.Model):  # pylint: disable=name-too-long
    """Subscription identifiers.
...
class PrivateLinkResourcesResult(_serialization.Model):
    ...
    :ivar next_link: The URL to get the next set of private link resources, if there are any.
    :vartype next_link: str
    """
    ...
    def __init__(self, *, next_link: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword next_link: The URL to get the next set of private link resources, if there are any.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
