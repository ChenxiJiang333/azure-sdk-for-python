...
class TestMachineLearningServicesMgmtComputeOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_compute_update_custom_services(self, resource_group):
            ...
            custom_services=[
                {
                    ...
                    "endpoints": [{"hostIp": "str", "name": "str", "protocol": "str", "published": 0, "target": 0}],
                    "environmentVariables": {"str": {"type": "str", "value": "str"}},
                    "image": {"reference": "str", "type": "str", "version": "str"},
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_compute_update_data_mounts(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_compute_update_idle_shutdown_setting(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_compute_get_allowed_resize_sizes(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_compute_begin_resize(self, resource_group):
        response = await (
