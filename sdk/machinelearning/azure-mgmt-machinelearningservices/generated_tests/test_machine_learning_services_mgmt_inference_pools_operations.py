...
class TestMachineLearningServicesMgmtInferencePoolsOperations(AzureMgmtRecordedTestCase):
    ...
    @recorded_by_proxy
    def test_inference_pools_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_inference_pools_begin_create_or_update(self, resource_group):
        response = self.client.inference_pools.begin_create_or_update(
            ...
            body={
                ...
                "properties": {
                    ...
                    "scaleUnitConfiguration": {"disablePublicEgress": bool, "registries": ["str"]},
                },
                "id": "str",
                "identity": {
                    "type": "str",
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_inference_pools_begin_update(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_inference_pools_begin_delete(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy
    def test_inference_pools_list(self, resource_group):
