...
class TestMachineLearningServicesMgmtEndpointDeploymentOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_endpoint_deployment_get_in_workspace(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_endpoint_deployment_list(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_endpoint_deployment_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_endpoint_deployment_begin_create_or_update(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_endpoint_deployment_begin_delete(self, resource_group):
        response = await (
