...
class TestMachineLearningServicesMgmtInferenceEndpointsOperationsAsync(AzureMgmtRecordedTestCase):
    ...
    async def test_inference_endpoints_list(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_inference_endpoints_get(self, resource_group):
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_inference_endpoints_begin_create_or_update(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_inference_endpoints_begin_update(self, resource_group):
        response = await (
    ...
    @RandomNameResourceGroupPreparer(location=AZURE_LOCATION)
    @recorded_by_proxy_async
    async def test_inference_endpoints_begin_delete(self, resource_group):
        response = await (
