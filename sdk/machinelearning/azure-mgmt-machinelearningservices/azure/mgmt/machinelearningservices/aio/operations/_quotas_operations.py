...
class QuotasOperations:
    ...
    @distributed_trace
    def list(self, location: str, **kwargs: Any) -> AsyncItemPaged["_models.ResourceQuota"]:
    ...
    async def update(
        ...
        :param location: The location name. Required.
        :type location: str
        :param parameters: The request body. Is either a QuotaUpdateParameters type or a IO[bytes]
         type. Required.
