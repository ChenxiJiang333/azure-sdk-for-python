...
def main():
    ...
    response = client.serverless_endpoints.begin_create_or_update(
        ...
        body={
            ...
            "properties": {
                "authMode": "Key",
                "contentSafety": {"contentSafetyLevel": "Blocking", "contentSafetyStatus": "Enabled"},
...
# x-ms-original-file: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/preview/2025-10-01-preview/examples/Workspace/ServerlessEndpoint/createOrUpdate.json
