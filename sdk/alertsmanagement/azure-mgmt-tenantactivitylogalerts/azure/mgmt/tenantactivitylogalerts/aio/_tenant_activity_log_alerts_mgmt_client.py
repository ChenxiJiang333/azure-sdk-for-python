...
from .operations import TenantActivityLogAlertsOperations
...
class TenantActivityLogAlertsMgmtClient:
    """Tenant Activity Log Alerts Client.

    :ivar tenant_activity_log_alerts: TenantActivityLogAlertsOperations operations
    :vartype tenant_activity_log_alerts:
     azure.mgmt.tenantactivitylogalerts.aio.operations.TenantActivityLogAlertsOperations
