...
# USAGE
    python tenant_activity_log_alert_rule_create_or_update.py
...
def main():
    ...
    response = client.tenant_activity_log_alerts.create_or_update(
...
# x-ms-original-file: specification/alertsmanagement/resource-manager/Microsoft.AlertsManagement/TenantActivityLogAlerts/preview/2023-04-01-preview/examples/TenantActivityLogAlertRule_CreateOrUpdate.json
