...
from ...operations._alerts_operations import (
    ...
    build_change_state_tenant_request,
    build_get_all_request,
    build_get_all_tenant_request,
    build_get_by_id_request,
    build_get_by_id_tenant_request,
    build_get_enrichments_request,
    build_get_history_request,
    build_get_history_tenant_request,
