...
class AlertEnrichmentsList(_serialization.Model):
    ...
    :ivar value: The AlertEnrichmentResponse items on this page. Required.
    ...
    def __init__(
        self, *, value: list["_models.AlertEnrichmentResponse"], next_link: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword value: The AlertEnrichmentResponse items on this page. Required.
...
class AlertProperties(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.egress_config: Optional[Any] = None
...
class OperationAutoGenerated(_serialization.Model):
    ...
    :vartype display: ~azure.mgmt.alertsmanagement.models.OperationDisplayAutoGenerated
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype display: ~azure.mgmt.alertsmanagement.models.OperationDisplayAutoGenerated
...
class PrometheusEnrichmentItem(_serialization.Model):
...
class PrometheusInstantQuery(AlertEnrichmentItem):
...
class PrometheusRangeQuery(AlertEnrichmentItem):
    """Prometheus instant query enrichment object.
