...
class AlertEnrichmentItem(_Model):
    ...
    type: str = rest_discriminator(name="type", visibility=["read", "create", "update", "delete", "query"])
    """The enrichment type. Required. Known values are: \"PrometheusInstantQuery\" and
     \"PrometheusRangeQuery\"."""
...
class AlertEnrichmentResponse(ArmProxyResource):
...
class PrometheusInstantQuery(AlertEnrichmentItem, discriminator="PrometheusInstantQuery"):
...
class PrometheusRangeQuery(AlertEnrichmentItem, discriminator="PrometheusRangeQuery"):
    """Prometheus instant query enrichment object.
