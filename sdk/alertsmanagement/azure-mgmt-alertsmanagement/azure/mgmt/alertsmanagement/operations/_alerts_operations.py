...
def build_get_all_tenant_request(
    *,
    target_resource: Optional[str] = None,
    target_resource_type: Optional[str] = None,
    target_resource_group: Optional[str] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.AlertsManagement/alerts")
...
def build_get_by_id_tenant_request(alert_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.AlertsManagement/alerts/{alertId}")
    path_format_arguments = {
        "alertId": _SERIALIZER.url("alert_id", alert_id, "str"),
    }
...
def build_change_state_tenant_request(
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.AlertsManagement/alerts/{alertId}/changestate")
    path_format_arguments = {
        "alertId": _SERIALIZER.url("alert_id", alert_id, "str"),
    }
...
def build_get_history_tenant_request(alert_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/providers/Microsoft.AlertsManagement/alerts/{alertId}/history")
    path_format_arguments = {
        "alertId": _SERIALIZER.url("alert_id", alert_id, "str"),
    }
...
class AlertsOperations:
    ...
    def get_summary(
        ...
        **kwargs: Any
        ...
        :type scope: str
        :param groupby: This parameter allows the result set to be grouped by input fields. For
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_get_all_tenant_request(
                    target_resource=target_resource,
                    target_resource_type=target_resource_type,
                    target_resource_group=target_resource_group,
                    monitor_service=monitor_service,
    ...
    def get_by_id_tenant(self, alert_id: str, **kwargs: Any) -> _models.Alert:
        ...
        _request = build_get_by_id_tenant_request(
            alert_id=alert_id,
            api_version=api_version,
            headers=_headers,
            params=_params,
    ...
    def change_state_tenant(
        ...
        **kwargs: Any
        ...
        _request = build_change_state_tenant_request(
            alert_id=alert_id,
            new_state=new_state,
            api_version=api_version,
            content_type=content_type,
    ...
    def get_history_tenant(self, alert_id: str, **kwargs: Any) -> _models.AlertModification:
        ...
        _request = build_get_history_tenant_request(
            alert_id=alert_id,
            api_version=api_version,
            headers=_headers,
            params=_params,
