...
- Model `ProxyResource` deleted or renamed its instance variable `system_data`
- Method `AlertsOperations.change_state` deleted or renamed its parameter `scope` of kind `positional_or_keyword`
- Method `AlertsOperations.get_all` deleted or renamed its parameter `scope` of kind `positional_or_keyword`
- Method `AlertsOperations.get_by_id` deleted or renamed its parameter `scope` of kind `positional_or_keyword`
- Method `AlertsOperations.get_enrichments` deleted or renamed its parameter `scope` of kind `positional_or_keyword`
- Method `AlertsOperations.get_history` deleted or renamed its parameter `scope` of kind `positional_or_keyword`
- Method `AlertsOperations.get_summary` deleted or renamed its parameter `scope` of kind `positional_or_keyword`
- Deleted or renamed enum value `TimeRange.ONE_D`
- Deleted or renamed enum value `TimeRange.ONE_H`
- Deleted or renamed enum value `TimeRange.SEVEN_D`
- Deleted or renamed enum value `TimeRange.THIRTY_D`
- Deleted or renamed model `ApiVersion`
- Deleted or renamed model `IdentifierAutoGenerated`
- Deleted or renamed model `OperationAutoGenerated`
- Deleted or renamed model `OperationDisplayAutoGenerated`
- Deleted or renamed model `PrometheusEnrichmentItem`
...
- Deleted model `AlertEnrichmentsList`/`AlertsList` which actually were not used by SDK users
