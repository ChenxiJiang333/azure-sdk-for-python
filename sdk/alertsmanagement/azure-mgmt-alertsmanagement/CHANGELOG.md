...
- Deleted model `OperationAutoGenerated`/`IdentifierAutoGenerated`/`ApiVersion`/`PrometheusEnrichmentItem`/`AlertEnrichmentsList`/`AlertsList` which actually were not used by SDK users
