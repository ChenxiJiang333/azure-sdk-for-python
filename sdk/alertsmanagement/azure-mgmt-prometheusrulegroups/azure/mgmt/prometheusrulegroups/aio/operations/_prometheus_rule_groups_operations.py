...
class PrometheusRuleGroupsOperations:
    ...
    async def get(
        ...
        deserialized = self._deserialize("PrometheusRuleGroupResource", pipeline_response.http_response)
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        rule_group_name: str,
        parameters: Union[_models.PrometheusRuleGroupResource, IO[bytes]],
        **kwargs: Any
    ) -> _models.PrometheusRuleGroupResource:
        """Create or update a Prometheus rule group definition.
    ...
    async def update(
        ...
        resource_group_name: str,
        rule_group_name: str,
        parameters: Union[_models.PrometheusRuleGroupResourcePatchParameters, IO[bytes]],
        **kwargs: Any
    ) -> _models.PrometheusRuleGroupResource:
        """Update an Prometheus rule group definition.
        ...
        :type parameters:
         ~azure.mgmt.prometheusrulegroups.models.PrometheusRuleGroupResourcePatchParameters or IO[bytes]
        :return: PrometheusRuleGroupResource or the result of cls(response)
        :rtype: ~azure.mgmt.prometheusrulegroups.models.PrometheusRuleGroupResource
        :raises ~azure.core.exceptions.HttpResponseError:
        """
