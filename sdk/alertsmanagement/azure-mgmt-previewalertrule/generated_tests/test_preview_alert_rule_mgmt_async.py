...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.previewalertrule.aio import PreviewAlertRuleMgmtClient
...
class TestPreviewAlertRuleMgmtAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(PreviewAlertRuleMgmtClient, is_async=True)
