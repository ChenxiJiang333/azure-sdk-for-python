...
# --------------------------------------------------------------------------
import pytest
from azure.mgmt.previewalertrule.aio import PreviewAlertRuleClient
...
class TestPreviewAlertRuleAsync(AzureMgmtRecordedTestCase):
    def setup_method(self, method):
        self.client = self.create_mgmt_client(PreviewAlertRuleClient, is_async=True)
