...
class BudgetTimePeriod(_serialization.Model):
    """The time period that defines the active period of the budget. The budget will evaluate data on
         ...
         *
    Constraints for **CategoryType: Cost** - Must be first of the month and should be less than the
        end date. Budget start date must be on or after June 1, 2017. Future start date should not be
        more than twelve months. Past start date should  be selected within the timegrain period.

         *
    Constraints for **CategoryType: ReservationUtilization** - Must be on or after the current date
        and less than the end date. Required.
        :vartype start_date: ~datetime.datetime
        :ivar end_date: The end date for the budget.


         *
    Constraints for **CategoryType: Cost** - No constraints. If not provided, we default this to 10
        years from the start date.

         *
    Constraints for **CategoryType: ReservationUtilization** - End date cannot be more than 3 years
...
class CostAllocationRuleList(_serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[list["_models.CostAllocationRuleDefinition"]] = None,
        ...
        **kwargs: Any
        ...
        :keyword next_link: URL to get the next set of rule list results if there are any.
        :paramtype next_link: str
        """
        super().__init__(**kwargs)
        self.value = value
...
class CostDetailsOperationResults(ProxyResource):
...
class EAPricesheetDownloadProperties(_serialization.Model):
    ...
    _attribute_map = {
        "download_url": {"key": "downloadUrl", "type": "str"},
        "valid_till": {"key": "validTill", "type": "iso-8601"},
        "download_file_properties": {"key": "downloadFileProperties", "type": "EAPriceSheetProperties"},
    }

    def __init__(
        self, *, download_file_properties: Optional["_models.EAPriceSheetProperties"] = None, **kwargs: Any
    ) -> None:
        """
...
class GenerateDetailedCostReportOperationResult(ProxyResource):  # pylint: disable=name-too-long
...
class GenerateDetailedCostReportOperationStatuses(ProxyResource):  # pylint: disable=name-too-long
...
class ScheduledAction(ProxyResource):
    ...
    :vartype scope: str
    :ivar status: Status of the scheduled action. Known values are: "Enabled", "Expired", and
     "Disabled".
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword e_tag: Resource Etag. For update calls, eTag is optional and can be specified to
         achieve optimistic concurrency. Fetch the resource's eTag by doing a 'GET' call first and then
         including the latest eTag as part of the request body or 'If-Match' header while performing the
         update. For create calls, eTag is not required.
        :paramtype e_tag: str
        ...
        :keyword scope: For private scheduled action(Create or Update), scope will be empty.\\
         ...
         ExternalSubscription scope.
        :paramtype scope: str
        :keyword status: Status of the scheduled action. Known values are: "Enabled", "Expired", and
         "Disabled".
