...
class AvailabilityStatus(float, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class EnrichmentTypeAutoGenerated(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class EntityItemQueryKindAutoGenerated(str, Enum, metaclass=CaseInsensitiveEnumMeta):
...
class TiTypeAutoGenerated(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """TiTypeAutoGenerated."""
