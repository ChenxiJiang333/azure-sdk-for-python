...
- Deleted model `ActionsList`/`AlertRuleTemplatesList`/`AlertRulesList`/`AutomationRulesList`/`BillingStatisticList`/`BookmarkList`/`DataConnectorList`/`EntityList`/`EntityQueryList`/`EntityQueryTemplateList`/`FileImportList`/`HuntCommentList`/`HuntList`/`HuntRelationList`/`IncidentAlertList`/`IncidentBookmarkList`/`IncidentCommentList`/`IncidentList`/`IncidentTaskList`/`JobList`/`MetadataList`/`OfficeConsentList`/`OperationsList`/`PackageList`/`ProductPackageList`/`ProductTemplateList`/`RecommendationList`/`RelationList`/`RepoList`/`SecurityMLAnalyticsSettingsList`/`SentinelOnboardingStatesList`/`SettingList`/`SourceControlList`/`TemplateList`/`ThreatIntelligenceInformationList`/`ThreatIntelligenceList`/`WatchlistItemList`/`WatchlistList`/`WorkspaceManagerAssignmentList`/`WorkspaceManagerConfigurationList`/`WorkspaceManagerGroupList`/`WorkspaceManagerMembersList`/`ProductPackageAdditionalProperties`/`QueryBasedAlertRuleTemplateProperties`/`ProductTemplateAdditionalProperties`/`RestApiPollerRequestPagingCountBaseConfig`/`RestApiPollerRequestPagingLinkHeaderConfig`/`RestApiPollerRequestPagingNextPageUrlConfig`/`RestApiPollerRequestPagingOffsetConfig`/`RestApiPollerRequestPagingTokenConfig`/`TeamProperties`/`TemplateAdditionalProperties`/`TemplateBaseProperties`/`ThreatIntelligenceMain`/`TiTypeAutoGenerated`/`TriggeredAnalyticsRuleRuns`/`AvailabilityStatus`/`DataConnectorDefinitionArmCollectionWrapper`/`DeviceImportance`/`EnrichmentTypeAutoGenerated`/`EntityItemQueryKindAutoGenerated`/`EntityResource`/`GetQueriesResponse` which actually were not used by SDK users
