...
from ...operations._container_apps_session_pools_operations import (
    ...
    build_fetch_mcp_server_credentials_request,
    build_get_request,
    build_list_by_resource_group_request,
    build_list_by_subscription_request,
    build_rotate_mcp_server_credentials_request,
...
class ContainerAppsSessionPoolsOperations:
    ...
    @distributed_trace_async
    async def fetch_mcp_server_credentials(
        self, resource_group_name: str, session_pool_name: str, **kwargs: Any
    ...
    @distributed_trace_async
    async def rotate_mcp_server_credentials(
        self, resource_group_name: str, session_pool_name: str, **kwargs: Any
    ) -> _models.McpServerCredential:
