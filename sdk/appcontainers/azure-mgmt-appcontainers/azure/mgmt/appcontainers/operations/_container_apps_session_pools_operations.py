...
def build_fetch_mcp_server_credentials_request(  # pylint: disable=name-too-long
    resource_group_name: str, session_pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_rotate_mcp_server_credentials_request(  # pylint: disable=name-too-long
    resource_group_name: str, session_pool_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ContainerAppsSessionPoolsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.SessionPool"]:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> ItemPaged["_models.SessionPool"]:
    ...
    def fetch_mcp_server_credentials(
        ...
        :param session_pool_name: Name of the session pool. Required.
        :type session_pool_name: str
        :return: McpServerCredential or the result of cls(response)
        :rtype: ~azure.mgmt.appcontainers.models.McpServerCredential
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._config.api_version))
        cls: ClsType[_models.McpServerCredential] = kwargs.pop("cls", None)

        _request = build_fetch_mcp_server_credentials_request(
            resource_group_name=resource_group_name,
            session_pool_name=session_pool_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
        ...
        deserialized = self._deserialize("McpServerCredential", pipeline_response.http_response)
    ...
    @distributed_trace
    def rotate_mcp_server_credentials(
        self, resource_group_name: str, session_pool_name: str, **kwargs: Any
    ) -> _models.McpServerCredential:
        ...
        _request = build_rotate_mcp_server_credentials_request(
            resource_group_name=resource_group_name,
            session_pool_name=session_pool_name,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
