...
def build_get_request(
    resource_group_name: str, container_app_name: str, function_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    path_format_arguments = {
        ...
        "functionName": _SERIALIZER.url("function_name", function_name, "str", pattern=r"^[-\w\._\(\)]+$"),
    }
...
class ContainerAppsFunctionsOperations:
    """
    .. warning::
    ...
    def list(
    ...
    ) -> ItemPaged["_models.ContainerAppsFunction"]:
        ...
        :return: An iterator like instance of either ContainerAppsFunction or the result of
         cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.appcontainers.models.ContainerAppsFunction]
        ...
        cls: ClsType[_models.ContainerAppsFunctionCollection] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize("ContainerAppsFunctionCollection", pipeline_response)
    ...
    def get(
        ...
        :return: ContainerAppsFunction or the result of cls(response)
        ...
        deserialized = self._deserialize("ContainerAppsFunction", pipeline_response.http_response)
