...
class ManagedEnvironmentsOperations:
    ...
    @distributed_trace
    def list_by_subscription(self, **kwargs: Any) -> ItemPaged["_models.ManagedEnvironment"]:
    ...
    ) -> ItemPaged["_models.ManagedEnvironment"]:
    ...
    def list_workload_profile_states(
        self, resource_group_name: str, environment_name: str, **kwargs: Any
    ) -> ItemPaged["_models.WorkloadProfileStates"]:
