...
class CapacityReservationGroupInstanceViewTypes(  # pylint: disable=name-too-long
...
class ConsistencyModeTypes(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    ...
    `https://aka.ms/RestorePoints <https://aka.ms/RestorePoints>`_ for more details.
    """
...
class ExpandTypesForGetCapacityReservationGroups(  # pylint: disable=name-too-long
    str, Enum, metaclass=CaseInsensitiveEnumMeta
):
...
class GalleryApplicationCustomActionParameterType(  # pylint: disable=name-too-long
    str, Enum, metaclass=CaseInsensitiveEnumMeta
):
...
class ResourceIdOptionsForGetCapacityReservationGroups(  # pylint: disable=name-too-long
    str, Enum, metaclass=CaseInsensitiveEnumMeta
):
