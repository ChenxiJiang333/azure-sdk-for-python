...
class AzureBareMetalInstancesOperations:
    ...
    def create(
        ...
        resource_group_name: str,
        azure_bare_metal_instance_name: str,
        request_body_parameters: Union[_models.AzureBareMetalInstance, IO[bytes]],
        **kwargs: Any
    ) -> _models.AzureBareMetalInstance:
        """Creates an Azure Bare Metal Instance for the specified subscription, resource group, and
        instance name.
        ...
        :param azure_bare_metal_instance_name: Name of the Azure Bare Metal Instance, also known as the
         ResourceName. Required.
        :type azure_bare_metal_instance_name: str
        :param request_body_parameters: Resource create parameters. Is either a AzureBareMetalInstance
         type or a IO[bytes] type. Required.
        :type request_body_parameters:
         ~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstance or IO[bytes]
        :return: AzureBareMetalInstance or the result of cls(response)
        :rtype: ~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstance
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_restart(
        ...
        **kwargs: Any
        ...
        :type force_parameter: ~azure.mgmt.baremetalinfrastructure.models.ForceState or IO[bytes]
        :return: An instance of LROPoller that returns either OperationStatus or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.baremetalinfrastructure.models.OperationStatus]
